...
$total_agent = mysqli_num_rows($resulta);

$sql4 = "SELECT property_detail.project_name,advertise.ad_status
FROM (advertise
LEFT JOIN property_detail ON advertise.pd_id = property_detail.pd_id)
WHERE property_detail.project_name != '' AND advertise.ad_status = '1' ";
$result4 = mysqli_query($con, $sql4) or die(mysqli_error($con));
$total_pro = mysqli_num_rows($result4);

$sql5 = "SELECT * FROM advertise WHERE ad_status = '1' ";
...
<head>
  ...
  <link rel="stylesheet" href="css/vendors/slick/slick.min.css">
  <link rel="stylesheet" href="css/vendors/magnific-popup/magnific-popup.min.css">
  <link rel="stylesheet" href="css/vendors/jquery-ui/jquery-ui.min.css">
  <link rel="stylesheet" href="css/vendors/chartjs/Chart.min.css">
  ...
  <main id="content">
    ...
    <section class="pt-lg-12 pb-lg-10 py-11">
      <div class="container container-xxl">
        <div class="row">
          <div class="col-md-6">
            <h2 class="text-heading">อสังหาริมทรัพย์ยอดนิยม</h2>
            <span class="heading-divider"></span>
          </div>
              ...
              <div class="card shadow-hover-2" data-animate="zoomIn">
                ...
                <div class="card-footer bg-transparent d-flex justify-content-between align-items-center py-3">
                  ...
                  <ul class="list-inline mb-0">
                    ...
                    <li class="list-inline-item">
                      <a id="compa" name="<?php echo $row7['a_id'] ?>" class="w-40px h-40 border rounded-circle d-inline-flex align-items-center justify-content-center text-body hover-secondary bg-hover-accent border-hover-accent"><i class="fas fa-exchange-alt"></i></a>
                    </li>
                  </ul>
                </div>
              </div>
    ...
    <section class="bg-secondary text-white pt-8 pb-7">
      <div class="container">
        <div class="row no-gutters">
          ...
          <div class="col-sm-6 col-lg-3 mb-6 mb-sm-0 px-6 text-center" data-animate="fadeInUp">
            <div class="counterup fs-56 lh-1 mb-3 pt-2" data-start="0" data-end="<?php echo $total_pro ?> " data-decimals="0" data-duration="0" data-separator=""><?php echo $total_pro ?>
            </div>
            <div class="text-uppercase fs-13 lh-184 letter-spacing-163 opacity-7">โครงการที่เสร็จแล้ว</div>
          </div>
          <div class="col-sm-6 col-lg-3 mb-6 mb-sm-0 px-6 text-center" data-animate="fadeInUp">
            <div class="counterup fs-56 lh-1 mb-3 pt-2" data-start="0" data-end="<?php echo $total_agent ?>" data-decimals="0" data-duration="0" data-separator=""><?php echo $total_agent ?>
            </div>
            <div class="text-uppercase fs-13 lh-184 letter-spacing-163 opacity-7">ตัวแทน</div>
          </div>
          <div class="col-sm-6 col-lg-3 mb-6 mb-sm-0 px-6 text-center" data-animate="fadeInUp">
            <div class="counterup fs-56 lh-1 mb-3 pt-2" data-start="0" data-end="<?php echo $total ?>" data-decimals="0" data-duration="0" data-separator=""><?php echo $total ?>
            </div>
            <div class="text-uppercase fs-13 lh-184 letter-spacing-163 opacity-7">โพสต์</div>
          </div>
        </div>
      </div>
    </section>
    <section class="pt-lg-12 pb-lg-11 py-11">
      <div class="container container-xxl">
        <div class="row">
          <div class="col-md-6">
            <h2 class="text-heading">อสังหาริมทรัพย์ล่าสุด</h2>
            <span class="heading-divider"></span>
          </div>
          <div class="col-md-6 text-md-right">
            <a href="frontend/listing-grid.php" class="btn fs-14 text-secondary btn-accent py-3 lh-15 px-7 mb-6 mb-lg-0">ดูเพิ่มเติม
        ...
        <div class="slick-slider slick-dots-mt-0 custom-arrow-spacing-30" data-slick-options='{"slidesToShow": 3,"dots":true,"arrows":false,"responsive":[{"breakpoint": 1600,"settings": {"slidesToShow":3}},{"breakpoint": 992,"settings": {"slidesToShow":2,"arrows":false}},{"breakpoint": 768,"settings": {"slidesToShow": 2,"arrows":false,"dots":true,"autoplay":true}},{"breakpoint": 576,"settings": {"slidesToShow": 1,"arrows":false,"dots":true,"autoplay":true}}]}'>
          <?php while ($row2 = mysqli_fetch_array($result2)) {
            ...
            <div class="box pb-7 pt-2">
              <div class="card shadow-hover-2" data-animate="zoomIn">
                ...
                <div class="card-body pt-3">
                  <h2 class="card-title fs-16 lh-2 mb-0">
                    <a href="frontend/home-details.php?id=<?php echo $row2['a_id']; ?>" class="text-dark hover-primary"><?php echo $row2['title']; ?></a>
                  </h2>
                  <p class="card-text font-weight-500 text-gray-light mb-2"><?php if ($row2['house_no'] != '') {
                  ...
                  <ul class="list-inline d-flex mb-0 flex-wrap mr-n5">
                    <li class="list-inline-item text-gray font-weight-500 fs-13 d-flex align-items-center mr-5" data-toggle="tooltip" title="3 Bedroom">
                      ...
                      <?php echo $row2['bedroom'] ?> ห้อง
                    </li>
                    <li class="list-inline-item text-gray font-weight-500 fs-13 d-flex align-items-center mr-5" data-toggle="tooltip" title="3 Bathrooms">
                      <svg class="icon icon-shower fs-18 text-primary mr-1">
                        <use xlink:href="#icon-shower"></use>
                      </svg>
                      <?php echo $row2['bathroom'] ?> ห้อง
                    </li>
                    <li class="list-inline-item text-gray font-weight-500 fs-13 d-flex align-items-center mr-5" data-toggle="tooltip" title="Size">
                      <svg class="icon icon-square fs-18 text-primary mr-1">
                        <use xlink:href="#icon-square"></use>
                      </svg>
                      <?php echo $row2['space_area'] ?>
                    </li>
                    <li class="list-inline-item text-gray font-weight-500 fs-13 d-flex align-items-center mr-5" data-toggle="tooltip" title="1 Garage">
                      <svg class="icon icon-Garage fs-18 text-primary mr-1">
                        <use xlink:href="#icon-Garage"></use>
                      </svg>
                      <?php echo $row2['parking'] ?>
                    </li>
                  </ul>
                </div>
                <div class="card-footer bg-transparent d-flex justify-content-between align-items-center py-3">
    ...
    <section class="pt-lg-12 pb-lg-15 py-11">
      <div class="container container-xxl">
        <h2 class="text-heading">ทำเลยอดนิยม</h2>
        <span class="heading-divider"></span>
        <div class="slick-slider mx-n2" data-slick-options='{"slidesToShow": 4,"arrows":false, "autoplay":false,"dots":false,"responsive":[{"breakpoint": 1200,"settings": {"slidesToShow":3}},{"breakpoint": 992,"settings": {"slidesToShow":3}},{"breakpoint": 768,"settings": {"slidesToShow": 2}},{"breakpoint": 576,"settings": {"slidesToShow": 1}}]}'>
          <div class="box px-2" data-animate="fadeInUp">
            <div class="card text-white bg-overlay-gradient-8 hover-zoom-in">
              ...
              <div class="card-img-overlay d-flex justify-content-end flex-column p-4">
                <h2 class="card-title mb-0 fs-20 lh-182"><a href="single-property-1.html" class="text-white"> พระราม
                    9</a></h2>
                <p class="card-text fs-13 font-weight-500 letter-spacing-087">จาก<span class="ml-2 fs-15 font-weight-bold">5,400,000 บาท - 9,000,000 บาท</span></p>
              </div>
            </div>
          </div>
          <div class="box px-2" data-animate="fadeInUp">
            <div class="card text-white bg-overlay-gradient-8 hover-zoom-in">
              ...
              <div class="card-img-overlay d-flex justify-content-end flex-column p-4">
                <h2 class="card-title mb-0 fs-20 lh-182"><a href="single-property-1.html" class="text-white"> อโศก
                    ทองหล่อ</a></h2>
                <p class="card-text fs-13 font-weight-500 letter-spacing-087">จาก<span class="ml-2 fs-15 font-weight-bold">5,200,000 บาท - 7,000,000 บาท</span></p>
              </div>
            </div>
          </div>
          <div class="box px-2" data-animate="fadeInUp">
            <div class="card text-white bg-overlay-gradient-8 hover-zoom-in">
              ...
              <div class="card-img-overlay d-flex justify-content-end flex-column p-4">
                <h2 class="card-title mb-0 fs-20 lh-182"><a href="single-property-1.html" class="text-white"> รัชดา
                    ห้วยขวาง</a></h2>
                <p class="card-text fs-13 font-weight-500 letter-spacing-087">จาก<span class="ml-2 fs-15 font-weight-bold">3,400,000 บาท - 6,000,000 บาท</span></p>
              </div>
            </div>
          </div>
          <div class="box px-2" data-animate="fadeInUp">
            <div class="card text-white bg-overlay-gradient-8 hover-zoom-in">
              ...
              <div class="card-img-overlay d-flex justify-content-end flex-column p-4">
                <h2 class="card-title mb-0 fs-20 lh-182"><a href="single-property-1.html" class="text-white"> สาทร </a>
                </h2>
                <p class="card-text fs-13 font-weight-500 letter-spacing-087">จาก<span class="ml-2 fs-15 font-weight-bold">2,400,000 บาท - 6,600,000 บาท</span></p>
              </div>
            </div>
          </div>
          <div class="box px-2" data-animate="fadeInUp">
            <div class="card text-white bg-overlay-gradient-8 hover-zoom-in">
              ...
              <div class="card-img-overlay d-flex justify-content-end flex-column p-4">
                <h2 class="card-title mb-0 fs-20 lh-182"><a href="single-property-1.html" class="text-white"> หมอชิด
                    จตุจักร </a></h2>
                <p class="card-text fs-13 font-weight-500 letter-spacing-087">จาก<span class="ml-2 fs-15 font-weight-bold">3,800,000 บาท - 6,800,000 บาท</span></p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="bg-accent pt-10 pb-lg-11 pb-8 bg-patten-04">
      <div class="container container-xxl">
        <h2 class="text-dark text-center mxw-751 fs-26 lh-184 px-md-8">
          เรามีรายชื่อมากที่สุดและการอัปเดตอย่างต่อเนื่อง <br> ดังนั้นคุณจะไม่พลาด</h2>
        ...
        <div class="row">
          <div class="col-ld-6 col-sm-7" data-animate="fadeInLeft">
            <div class="pl-6 border-4x border-left border-primary">
              <h2 class="text-heading lh-15 fs-md-32 fs-25">สำหรับข้อมูลเพิ่มเติมเกี่ยวกับบริการของเรา<span class="text-primary"> ได้รับการติดต่อ </span> กับที่ปรึกษาผู้เชี่ยวชาญ </h2>
              <p class="lh-2 fs-md-15 mb-0">10 ข้อเสนอใหม่ทุกวัน ข้อเสนอ 350 บนเว็บไซต์ เชื่อถือได้โดยชุมชนของ
                ผู้ใช้หลายพันคน</p>
            </div>
          </div>
          <div class="col-ld-6 col-sm-5 text-center mt-sm-0 mt-8" data-animate="fadeInRight">
            <i class="fal fa-phone fs-40 text-primary"></i>
            <p class="fs-13 font-weight-500 letter-spacing-173 text-uppercase lh-2 mt-3">โทรขอความช่วยเหลือทันที!</p>
            <p class="fs-md-42 fs-32 font-weight-600 text-secondary lh-1">1900 68668</p>
            <a href="#" class="btn btn-lg btn-primary mt-2 px-10">ติดต่อเรา</a>
          </div>
        </div>
      </div>
    </section>
