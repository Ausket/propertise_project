                ...
                <div class="row">
                    <div class="offset-3 col-md-6">
                        ...
                        <div class="card card-dark">
                            ...
                            <form action="../backend/edit_banner_db.php?id=<?php echo $row2['a_id'] ?>" enctype="multipart/form-data" method="POST">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <?php if($row2['a_img'] != '') {?>
                                                <img src="../image/a_img/<?php echo $row2['a_img']; ?>" width="40%"><?php } ?> &nbsp;&nbsp;
                                            </div>
                                            <div class="form-group col-md-4">
