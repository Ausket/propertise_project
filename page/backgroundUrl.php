...
<head>
    ...
    <!-- Facebook -->
    <meta property="og:url" content="contact-us-2.html">
...
<body>
    ...
    <body>
        <?php include '../frontend/templates/header-three.php'; ?>
        <main id="content">
            ...
            <section class="pt-8 pb-9">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="d-block m-auto" style="padding-top: 0 !important; text-align: center;">
                                <div class="box-100 mt-6">
                                    <img class="img-three" src="../images/check.png" width="200px">
                                </div>
                                <div class="box-100">
                                    <p class="text-one text-primary fs-32"> คุณซื้อแพ็คเก็จ...สำเร็จแล้ว </p>
                                    <p> </p>
                                </div>
                                <a href="../frontend/packages.php" class="btn btn-lg btn-primary mb-3 " ><i class="fal fa-long-arrow-left"></i> กลับไปหน้าแพ็คเก็จ
                                  <span class="d-inline-block ml-2 fs-16"></span>
                                </a>
                                <a href="../frontend/dashboard-my-packages.php" class="btn btn-lg btn-accent accent-blue hover-primary mb-3 " >ไปหน้ารายการสั่งซื้อ
        ...
        <?php include '../frontend/templates/footer-two.php'; ?>
        <!-- Vendors scripts -->
