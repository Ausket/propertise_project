    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 style="text-transform: uppercase">เพิ่มนายหน้า</h1>
                    </div>
                ...
                <div class="row">
                        ...
                        <div class="card card-pink card-outline">
                            <div class="card-body box-profile">
                                <div class="text-center">
                                    <img class="profile-user-img img-fluid img-circle" id="imageUpload2" src="../m_img/user.png" alt="User profile picture">
                                    ...
                                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="../backend/addagent_db.php" enctype="multipart/form-data" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card card-dark">
                        <div class="card-header">
                            <h3 class="card-title">เพิ่มนายหน้า</h3>
                        </div>
                        <div class="card-body">
                            <!-- /.card-header -->
                            <!-- form start -->
