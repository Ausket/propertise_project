        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 style="text-transform: uppercase">เพิ่มข้อมูล</h1>
                        </div>
                    ...
                    <div class="row">
                        <div class="offset-sm-3 col-md-6">
                            ...
                            <div class="card card-dark">
                                ...
                                <form action="../backend/add_propertise_type_db.php" method="POST">
                                    <div class="card-body">
                                        <div class="form-group">
                                           

                                            <label for="exampleInputEmail1">ประเภทอสังหา</label>
                                            <input type="text" class="form-control" id="exampleInputEmail1" name="type" value="" placeholder="Propertise Type" required>
