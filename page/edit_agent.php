  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="text-transform: uppercase">แก้ไขนายหน้า</h1>
          </div>
          ...
          <div class="offset-sm-3 col-md-6">
                  ...
                  <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <form class="form-horizontal" action="../backend/edit_agent_db.php?id=<?php echo $rowm['u_id'] ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="card card-dark">
              <div class="card-header ">
                <h3 class="card-title">แก้ไขนายหน้า</li>
              </div><!-- /.card-header -->
              <div class="card-body">
