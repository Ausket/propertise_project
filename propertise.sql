...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 21, 2022 at 10:48 AM
...
(1, 1, 1, 1, 1, 'title', '<p>test002</p>\r\n', 16, '2022-01-14 13:07:41', '1'),
(2, 1, 1, 2, 2, 'ขายบ้านมือสอง', 'ขายบ้านมือสอง', 3, '2022-01-14 13:07:41', '1'),
(4, 1, 2, 6, 6, 'คอนโดหรูติดแม่น้ำ', '<p>คอนโดหรูติดแม่น้ำ</p>\r\n', 16, '2022-01-19 22:22:44', '1'),
...
(11, 'กสิกร', ' 1 ก.พ. - 30 เม.ย. 2564', '9.75%', '5.9700%', 'วงเงินให้กู้ได้ไม่เกิน 90% ของราคาซื้อขาย และไม่เกิน 90% ของราคาประเมินหลักประกัน', '012344234', '002429e4b28532ce5273cafa10be61c2.202201129264.jpg');
...
(13, 'home202201196363.png', '2022-01-19 22:21:26', '6'),
...
(49, 'icon-avatar-6202201211207.jpg', '2022-01-21 15:27:09', '34'),
(50, 'fanta202201211207.jpg', '2022-01-21 15:27:09', '34'),
...
INSERT INTO `history_package` (`hp_id`, `packtype_id`, `u_id`, `start_date`, `end_date`, `payment_method`, `note`) VALUES
(1, 1, 31, '2021-12-16', '2022-03-16', 'บัตรเครดิต', '-'),
(2, 3, 23, '2019-10-17', '2022-08-17', 'สแกนผ่าน qrcode', '-');
...
(34, '44', '6', '', '', 1, 6, 100603, '73110', NULL, NULL, 3),
...
(6, 6, 'loveland', '2', '1', '1', '2100000', '20 ตาราวา', 'kitkat.202201194481.png', 2, 16, '1', ''),
...
(33, 33, 'ไม่มี', '2', '1', '1', '1500000', '18 ตาราวา', 'bank.202201202468.png', 2, 3, '1', 'สระว่ายน้ำ,สวนสาธารณะ,สนามเด็กเล่น'),
(34, 34, 'wonderland', '2', '1', '1', '1500000', '18 ตาราวา', 'home.202201216580.png', 2, 3, '1', 'สระว่ายน้ำ,สวนสาธารณะ,ฟิตเนส,เครื่องปรับอากาศ,Wi-Fi'),
(35, 35, 'wonderland', '2', '1', '1', '1500000', '18 ตาราวา', 'home.png', 2, 3, '0', 'สระว่ายน้ำ,ห้องสมุด,ฟิตเนส,เครื่องปรับอากาศ,Wi-Fi');
...
(3, 'superadmin', 'admin@hotmail.com', '123456', 'Soul City', '0800605960', '1104000028097', '1999-02-25', 'ไม่มี', '16423578326146.png', 'admin', '1', 0),
...
(16, 'ausiri', 'ausiri@hotmail.com', '123456', '39/2 หมู่ 3 ต.สามพราน อ.สามพราน จ.นครปฐม', '034882342', '1104000028092', '2022-01-18', 'ไม่มี', '16423592288746.png', 'member', '1', 0),
...
(39, 'Kitkat002', 'kitty@hotmail.com', '123456', '39/2 หมู่ 3 ต.สามพราน อ.สามพราน จ.นครปฐม', '0964545535', '1104000028009', '2000-01-21', 'ไม่มี', '16423577933517.png', 'member', '1', 0),
...
--
ALTER TABLE `advertise`
  MODIFY `a_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `file`
  MODIFY `f_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
...
--
ALTER TABLE `history_package`
  MODIFY `hp_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `property_detail`
  MODIFY `pd_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `users`
  MODIFY `u_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
