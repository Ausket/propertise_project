...
<head>
  ...
  <!-- Facebook -->
  <meta property="og:url" content="dashboard-my-profiles.html">
      ...
      <div class="page-content">
        ...
        <main id="content" class="bg-gray-01">
          <div class="px-3 px-lg-6 px-xxl-13 py-5 py-lg-10">
              ...
              <div class="col-lg-12">
                <div class="card mb-12">
                  <div class="card-body px-6 pt-6">
                    <div class="row">
                      <div class="col-sm-4 col-xl-12 col-xxl-12 mb-6">
                        <h3 class="card-title mb-0 text-heading fs-22 lh-15">รูปภาพโปรไฟล์</h3>
                        <p class="card-text">อัปโหลดรูปโปรไฟล์ของคุณ</p>
                      </div>
                      <div class="col-12 d-flex justify-content-center" style="flex-wrap: wrap;">
                        <div class="col-sm-4 col-xl-6 col-xxl-4">
                          <div style="width: 100%; display:flex; justify-content:center">
                            <img src="../image/m_img/<?php echo $row['img']; ?>" alt="My Profile" id="imageUpload2" class="w-50">
                          </div>
                          <div class="custom-file mt-4 h-auto">
                            <label class="btn btn-secondary btn-lg btn-block" data-toggle="modal" data-target="#exampleModal">
                              <span class="d-inline-block mr-1"><i class="fal fa-cloud-upload"></i></span>อัพเดตรูปโปรไฟล์</label>
                          </div>
                        </div>
                      </div>
                      <form class="form-horizontal col-12" action="../backend/edit_profile_db.php?id=<?php echo $row['u_id'] ?>" method="post">
                        <div class="card-body px-6 pt-5 pb-5">
                          ...
                          <div class="form-row mx-n4">
                            <div class="form-group col-md-12 px-4 mb-md-0">
                              <label for="address" class="text-heading"> ที่อยู่ </label>
                              <textarea class="form-control form-control-lg border-0" name="address" id="address" cols="30" rows="5" value="" required><?php echo $row['address']; ?></textarea>
                            </div>
                          </div>
                        </div>
                    </div>
            ...
            <form class="form-horizontal" action="../backend/reset_pass.php?id=<?php echo $row['u_id'] ?>" method="post">
              <div class="card">
                <div class="card-body px-6 pt-6">
                  <h3 class="card-title mb-0 text-heading fs-22 lh-15 pb-6">เปลี่ยนรหัสผ่าน</h3>
                  <div class="form-group">
                    <label for="oldPassword" class="text-heading">รหัสผ่านปัจจุบัน</label>
                    <input type="password" class="form-control form-control-lg border-0" id="oldpassword" name="oldpassword" required>
                  </div>
                  <div class="form-row mx-n4">
                    <div class="form-group col-md-6 col-lg-12 col-xxl-6 px-4">
                      <label for="newPassword" class="text-heading">รหัสผ่านใหม่</label>
                      <input type="password" class="form-control form-control-lg border-0" id="newpassword" name="newpassword" required>
                    </div>
                    <div class="form-group col-md-6 col-lg-12 col-xxl-6 px-4">
                      <label for="confirmNewPassword" class="text-heading">พิมพ์รหัสผ่านใหม่อีกครั้ง</label>
                      <input type="password" class="form-control form-control-lg border-0" id="repassword" name="repassword" required>
                    </div>
                  </div>
                </div>
                <div class="d-flex justify-content-center flex-wrap">
                  <button class="btn btn-lg btn-primary mb-8" name="submit" type="submit"> อัพเดตรหัสผ่าน </button>
                </div>
              </div>
            </form>
          </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">อัพเดตรูปโปรไฟล์</h5>
        ...
        <form action="../backend/updateImage.php" method="post" enctype="multipart/form-data">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" name="submit" class="btn btn-primary">บันทึกรูปภาพ</button>
          </div>
        </form>
      </div>
    </div>
