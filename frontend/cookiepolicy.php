...
<section class="CookiePolicy">
    <div class="container">
        <header class="PolicyHeader">
            <h1 class="mt-6">นโยบายการใช้คุกกี้</h1>
            <p></p>
        </header>
        <div class="CookiePolicyWrap">
            <p>ปรับปรุงเมื่อ 16 เมษายน 2563</p>
            <p>Sanook.com และผู้ให้บริการรายอื่นตั้งค่าและใช้คุกกี้ รวมถึงเทคโนโลยีที่คล้ายคลึงกันเพื่อจัดเก็บ ดูแลข้อมูลการใช้งานของผู้ใช้งาน ส่งโฆษณา ให้บริการบทความ วิเคราะห์และจัดเก็บการใช้งานบนบริการ ยกตัวอย่างเช่น การใช้คุกกี้และเทคโนโลยีติดตามอื่นๆ เป็นพื้นฐานสำหรับการจัดเก็บข้อมูลออนไลน์ของผู้ใช้งานผ่านเว็บไซต์และแอปพลิเคชัน หรือบริการอื่นๆ สำหรับข้อมูลเพิ่มเติมว่าเราใช้คุกกี้และเทคโนโลยีที่เหมือนกัน รวมถึงเราควบคุมเครื่องมือต่างๆ อย่างไรจะถูกระบุไว้อยู่ด้านล่างนี้</p>
            <p>กรณีที่ท่านต้องการข้อมูลเพิ่มเติมเกี่ยวกับการใช้คุกกี้ของเรา ท่านสามารถติดต่อมายังเจ้าหน้าที่ควบคุมข้อมูลส่วนบุคคลอีเมล
                <a href="mailto:legal-ca@tencent.co.th?Subject=ต้องการข้อมูลเพิ่มเติมเกี่ยวกับการใช้คุกกี้" title="ต้องการข้อมูลเพิ่มเติมเกี่ยวกับการใช้คุกกี้">legal-ca@tencent.co.th</a>
            </p>
        </div>
        <div class="CookiePolicyWrap">
            <h2 class="PolicyTitle">สารบัญ :</h2>
            <ul class="CookieMenu">
                <li><a href="#secPrimary">คุกกี้คืออะไร</a></li>
                <li><a href="#secSecondary">เราใช้คุกกี้อย่างไร</a></li>
                <li><a href="#secTertiary">ชนิดของคุกกี้</a></li>
                <li><a href="#secQuaternary">การจัดการคุกกี้</a></li>
                <li><a href="#secQuinary">สัญลักษณ์ที่ไม่ให้ติดตาม (Do Not Track)</a></li>
                <li><a href="#secSenary">การเชื่อมต่อผ่านสื่อสังคมออนไลน์</a></li>
            </ul>
        </div>
        <div class="CookiePolicyWrap"><span id="secPrimary" class="CookiePolicyId"></span>
            <h2>คุกกี้คืออะไร</h2>
            <p>คุกกี้คือไฟล์ข้อมูลเล็กๆ วางอยู่บนคอมพิวเตอร์และอุปกรณ์อื่นๆ ที่ใช้ระบุตัวตนและจดจำผู้ใช้งาน หรืออุปกรณ์เพื่อจะจัดเก็บข้อมูล เราอาจทำการเก็บรวบรวมข้อมูลจากท่านโดยอัตโนมัติผ่านคุกกี้หรือเทคโนโลยีอื่นที่คล้ายคลึงกันเมื่อท่านเยี่ยมชมเว็บไซต์ของเรา โดยคุกกี้จะถูกแบ่งประเภทไปตามหน้าที่การใช้งานและวัตถุประสงค์การใช้งาน ได้แก่ คุกกี้ที่จำเป็นสำหรับการใช้งาน คุกกี้ปฏิบัติงาน คุกกี้เพื่อปรับปรุงประสิทธิผล และคุกกี้สำหรับการตลาด</p>
        </div>
        <div class="CookiePolicyWrap"><span id="secSecondary" class="CookiePolicyId"></span>
            <h2>เราใช้คุกกี้อย่างไร</h2>
            <p>เราและหุ้นส่วนบุคคลภายนอกของเราอาจเก็บรวบรวมข้อมูลผ่านคุกกี้สำหรับข้อมูลการเข้าใช้บริการ เพื่อพัฒนาประสบการณ์การใช้งานของท่านให้ดียิ่งขึ้นและเพื่อวัตถุประสงค์อื่นๆ รวมถึง</p>
            <ol>
                <li>จดจำผู้ใช้งาน ยกตัวอย่างเช่น คุกกี้จะช่วยให้เราระบุตัวตนได้ว่าท่านคือผู้ใช้งานที่ลงทะเบียนไว้บนบริการของเรา หรือเก็บการตั้งค่า หรือข้อมูลที่ท่านเคยให้เราไว้</li>
                <li>วิเคราะห์การใช้งานของท่านบนบริการของเรา เราสามารถใช้คุกกี้เพื่อจะเข้าใจว่าผู้ใช้บริการใช้งานอะไรบ้างบนบริการของเรา หรือหน้าไหน ส่วนไหนของบริการที่เป็นที่นิยมที่สุด</li>
                <li>นำเสนอโฆษณา โดยใช้คุกกี้ช่วยให้เรานำเสนอโฆษณาที่เราเชื่อว่าท่านจะสนใจโดยมาจากข้อมูลของท่าน (ตามที่ระบุไว้ในหัวข้อเราใช้ข้อมูลของท่านอย่างไร และหัวข้อเกี่ยวกับโฆษณาในนโยบายความเป็นส่วนตัว)</li>
                <li>ข้อมูลบัตรเครดิตและข้อมูลทางการเงินอื่นๆ ซึ่งจำเป็นในการดำเนินการด้านธุรกรรมทางการเงินเมื่อท่านใช้บริการของเรา ซึ่งข้อมูลดังกล่าวอาจถูกเก็บรวบรวมและรักษาไว้โดยผู้ประมวลผลบุคคลภายนอก หรือผู้ประมวลผลด้านธุรกรรมทางการเงินของเราเอง ผู้ประมวลผลด้านธุรกรรมทางการเงินเหล่านั้น อาจจัดให้มีคุกกี้ซึ่งทำให้ท่านสามารถทำการจ่ายเงินในครั้งต่อๆ ไปโดยใช้ข้อมูลทางการเงินที่ท่านได้ให้ไว้เรียบร้อยแล้ว</li>
            </ol>
            <p>โปรดสังเกตว่าเราใช้คุกกี้เพื่อวัตถุประสงค์ดังกล่าวข้างต้น แต่อาจจะมีการจัดเก็บรวบรวมข้อมูลที่ไม่ใช่ข้อมูลส่วนบุคคลมาด้วยผ่านเทคโนโลยีเหล่านี้ เพื่อให้ผู้โฆษณาและหุ้นส่วนอื่นๆ ของเราวิเคราะห์ได้ว่าท่านและบุคคลอื่นๆ ใช้บริการเราอย่างไรเพื่อนำเสนอโฆษณาที่เหมาะสม</p>
            <p>เราอาจอนุญาตให้ผู้โฆษณาและหุ้นส่วนบุคคลภายนอกอื่นๆ มาวางคุกกี้ เว็บบีคอน และเทคโนโลยีที่คล้ายคลึงกัน ไว้บนบางบริการของเราเพื่อวิเคราะห์ว่าบริการเหล่านี้ถูกใช้อย่างไรและนำไปเสนอโฆษณา โปรดสังเกตว่าการใช้คุกกี้ของบุคคลภายนอกอยู่ภายใต้นโยบายความเป็นส่วนตัวของพวกเขาเอง เราไม่อาจรับผิดชอบในการใช้คุกกี้ของบุคคลภายนอก</p>
            <p>คุกกี้ที่ทางเราใช้เรียกว่า first-party cookies ส่วนคุกกี้ที่ใช้โดยหุ้นส่วนหรือบุคคลภายนอกคือ third-party cookies โดยเว็บไซต์ของเราจะไม่สามารถเข้าถึงข้อมูลที่จัดเก็บโดย third-party cookies ได้ และบริษัทอื่นๆ จะไม่สามารถเข้าถึงข้อมูลที่จัดเก็บผ่านคุกกี้ของเราเช่นกัน</p>
        </div>
        <div class="CookiePolicyWrap"><span id="secTertiary" class="CookiePolicyId"></span>
            <h2 class="PolicyTitle">ชนิดของคุกกี้</h2>
            <p>เราขออธิบายเพิ่มเติมในตารางด้านล่างว่าเราใช้คุกกี้แต่ละประเภทอย่างไรบนบริการของเรา โดยทั้งหมดหรือบางส่วนของคุกกี้อาจอยู่บนบราวเซอร์ของท่าน บราวเซอร์ของท่านอาจสามารถปิดหรือจัดการคุกกี้ได้ อย่างไรก็ตาม โปรดทราบว่าถ้าท่านทำเช่นนั้น เราอาจจะไม่สามารถปรับเปลี่ยนการใช้งานตามความชอบของท่านได้ และบริการบางส่วนของเราอาจไม่สามารถทำงานได้อย่างที่สมควร</p>
        </div>
        <div class="CookiePolicyWrap">
            <h2 class="PolicyTitle">ประเภทของคุกกี้ที่ใช้</h2>
            <p><strong>การระบุตัวตน :</strong>คุกนี้จะแจ้งให้เราทราบเมื่อท่านเข้ามาใช้บริการของเรา เพื่อที่เราจะสามารถให้บริการที่เหมาะสมและปลอดภัย เพื่อประสบการณ์ที่ดีของท่านได้ ยกตัวอย่างเช่น คุกกี้นี้จะแจ้งให้เราทราบเมื่อท่านลงชื่อเข้าใช้สมาชิก เพื่อจะช่วยให้เรารับรู้ได้ว่าท่านได้เข้าใช้งานระบบสมาชิกและแสดงข้อมูลที่เหมาะกับท่าน</p>
            <p><strong>การตั้งค่า :</strong>เราใช้คุกกี้ในการบันทึกรูปแบบ การตั้งค่าต่างๆ ของท่าน เพื่อที่จะมั่นใจว่าบริการของเราเหมาะสมกับท่าน คุกกี้เหล่านี้ช่วยให้เว็บไซต์ของเราในการจดจำข้อมูลซึ่งจะเปลี่ยนแปลงการแสดงผล เช่น ภาษาที่ท่านตั้งค่า หรือภูมิภาคที่ท่านอยู่ ยกตัวอย่างเช่น</p>
            <ul>
                ...
                <li>บันทึกการตั้งค่าของท่าน (เช่น ขนาดตัวอักษร) เพื่อที่ว่าบริการอื่นๆ ที่เกี่ยวข้องของเราจะปรับการตั้งค่าดังกล่าวโดยอัตโนมัติเมื่อท่านเข้าใช้งานอีกครั้ง</li>
            </ul>
            <p>หากท่านดำเนินการลบข้อมูลดังกล่าวซึ่งเก็บโดยคุกกี้ การตั้งค่าอาจส่งผลให้ประสบการณ์การใช้งานบนเว็บไซต์ของเราไม่ได้ประสิทธิภาพเท่าที่ควร แต่จะไม่เป็นอุปสรรคต่อการใช้บริการของเรา</p>
            <p><strong>ความปลอดภัย :</strong>เราใช้คุกกี้เพื่อยกระดับการรักษาความปลอดภัยข้อมูลของท่าน และเพื่อป้องกันการฉ้อฉล อาชญากรรม หรือกิจกรรมอื่นๆ ที่น่าสงสัย ยกตัวอย่างเช่น คุกกี้นี้สามารถระบุได้ว่าท่านลงชื่อเข้าใช้สมาชิกบนบริการของเราในพื้นที่ประจำหรือไม่ และเพื่อป้องกันการแอบอ้างตัวตนและข้อมูลที่ไม่เหมาะสมอื่นๆ</p>
            <p><strong>ระบบ :</strong>เราใช้คุกกี้นี้เพื่อแสดง และปรับปรุงบริการของเรา ยกตัวอย่างเช่น คุกกี้นี้ช่วยเหลือเราในการกรอกข้อมูลบัญชีของท่านล่วงหน้า ขณะจะทำการลงชื่อเข้าใช้งานบนบริการของเรา ช่วยให้ท่านใช้บริการของเราได้อย่างมีประสิทธิภาพมากขึ้น</p>
            <p><strong>ประสิทธิผล :</strong>เราใช้คุกกี้นี้เพื่อปรับปรุงความเร็ว สมรรถนะ และประสิทธิผลของบริการของเรา ยกตัวอย่างเช่น คุกกี้นี้สามารถช่วยเรื่องการไหลเวียนของเราเตอร์ระหว่างเซิร์ฟเวอร์ และประเมินความเร็วในการโหลดข้อมูลของบริการเราเมื่อมีผู้ใช้งานจำนวนมาก เราอาจใช้คุกกี้นี้ในการบันทึกข้อมูลชั่วคราวบนบราวเซอร์ของท่านเพื่อที่จะสามารถโหลดข้อมูลและตอบสนองความเร็วได้มากขึ้นเมื่อท่านเข้ามาใช้บริการของเรา</p>
            <p><strong>วิเคราะห์และวิจัย :</strong>เราใช้คุกกี้นี้เพื่อติดตามและปรับปรุงบริการของเรา และเพื่อช่วยเราหาข้อมูลอ้างอิงสำหรับการวิจัยและพัฒนาบริการหรือระบบใหม่ๆ ของเรา ยกตัวอย่างเช่น คุกกี้ช่วยเราเข้าใจได้ดีขึ้นว่าท่านใช้บริการของเราอย่างไร และช่วยให้เราปรับปรุงประสบการณ์ใช้งานของท่านหรือผู้ใช้อื่นบนบริการของเรา ข้อมูลดังกล่าวอาจรวมถึงเวลาที่ท่านใช้งานบริการเราในแต่ละครั้ง ตลอดจนหน้าและระบบไหนบ้างที่ท่านเข้ามาใช้บริการของเรา</p>
            <p><strong>การโฆษณา :</strong>เราใช้คุกกี้นี้เพื่อปรับปรุงโฆษณาของเราเพื่อนำเสนอให้เหมาะสมตามความชอบของท่าน ยกตัวอย่างเช่น คุกกี้นี้ช่วยให้เราแสดงโฆษณาที่เกี่ยวข้องกับท่านมากขึ้นและติดตามว่าโฆษณาใดบ้างที่ท่านเปิดอ่านหรือดูบนบริการของเราและเข้าไปดโฆษณานั้นๆ ของผู้โฆษณา ในกรณีเดียวกัน หุ้นส่วนของเราอาจใช้คุกกี้นี้เพื่อให้แน่ใจว่าเราแสดงโฆษณาอย่างมีประสิทธิผล หรือให้ข้อมูลเราถึงการติดต่อระหว่างท่านกับผู้ลงโฆษณา</p>
        </div>
        <div class="CookiePolicyWrap"><span id="secQuaternary" class="CookiePolicyId"></span>
            <h2 class="PolicyTitle">การจัดการคุกกี้</h2>
            <p>ท่านสามารถบริหารจัดการคุกกี้บนเว็บไซต์ผ่านการตั้งค่าบนบราวเซอร์ได้ และท่านมีทางเลือกที่จะเปลี่ยนแปลงการตั้งค่าโดยยอมรับ ปฏิเสธ หรือลบคุกกี้ ถ้าท่านเลือกจะเปลี่ยนแปลงการตั้งค่า ท่านอาจจะพบว่าระบบหรือบริการของเราอาจไม่สามารถบริการได้เต็มประสิทธิภาพ การตั้งค่าบนบนบราวเซอร์แต่ละประเภทค่อนข้างจะแตกต่างกัน ดังนั้นเพื่อจะบริหารจัดการคุกกี้ ท่านควรเข้าไปตรวจสอบการตั้งค่าบนบราวเซอร์ของท่าน</p>
            <p>เราเข้าใจว่าท่านอาจจะต้องการรู้จักคุกกี้มากขึ้น ดังนั้นเราจะจึงจะจัดหาแหล่งข้อมูลเกี่ยวกับประเภทของคุกกี้ให้ท่านทราบ รวมถึงแต่ละประเภทจะถูกใช้อย่างไร และท่านสามารถปรับการตั้งค่าคุกกี้อย่างไร บน
                <a href="https://www.aboutcookies.org/" title="" target="_blank">www.aboutcookies.org</a> หรือ
                <a href="https://www.allaboutcookies.org/" title="" target="_blank">www.allaboutcookies.org</a> ทั้งนี้โปรดเข้าไปยังไอคอนด้านล่างนี้สำหรับรายละเอียดที่จะปิดหรือลบคุกกี้สำหรับบราวเซอร์ทั่วๆ ไป ดังนี้
            </p>
            <ul>
                ...
                <li><a href="https://support.microsoft.com/en-us/help/17442/windows-internet-explorer-delete-manage-cookies#ie=ie-11" target="_blank">Microsoft® Internet Explorer</a></li>
                <li><a href="https://support.google.com/accounts/answer/61416?hl=en" target="_blank">Google Chrome™</a></li>
                <li><a href="https://support.apple.com/en-us/HT201265" target="_blank">Safari®</a></li>
            </ul>
            <p>เรายังมีการใช้เทคโนโลยีติดตามอื่นๆ นอกเหนือจากคุกกี้ดังนี้</p>
            <ul class="mb-6">
                <li>การแชร์ข้อมูลท้องถิ่น หรือ แฟลชคุกกี้ ถูกออกแบบมาเพื่อสนับสนุนข้อมูล บทความบนบราวเซอร์ โดยอโดบีแฟลช คุกกี้เหล่านี้ถูกใช้ในการลงโฆษณาและบทความ วิดีโอ บนเว็บไซต์ เหมือนคุกกี้ประเภทอื่นๆทีจะเก็บข้อมูลบนอุปกรณ์ของท่าน บางอันจะถูกใช้เพื่อให้สามารถใช้งานโปรแกรมแฟลช โดยแฟลชคุกกี้จะถูกลบได้จากภายในอโดบีแฟลชเท่านั้นไม่ใช่บนบราวเซอร์ กรุณาเข้าไปดูวิธีการจัดการตั้งค่าความเป็นส่วนตัวของท่านและลบแฟลชคุกกี้ได้ที่
                    <a href="http://www.macromedia.com/support/documentation/en/flashplayer/help/settings_manager.html" title="" target="_blank">http://www.macromedia.com/support/documentation/en/flashplayer/help/settings_manager.html</a>
                </li>
                <li>เว็บเซิร์ฟเวอร์ และข้อมูลการใช้งานแอปพลิเคชัน บริการของเราจะจัดเก็บข้อมูลอัตโนมัติเพื่อช่วยเราตรวจสอบและป้องกันบริการของเรา วิเคราะห์การใช้งาน และปรับปรุงประสบการณ์ใช้งานของผู้ใช้งาน ข้อมูลที่ถูกจัดเก็บจะมีดังนี้<ul>
                        <li>ไอพีแอดเดรส และชนิดของบราวเซอร์</li>
                        <li>ข้อมูลอุปกรณ์ รวมถึงที่ระบุตัวตนของอุปกรณ์ (UDID) ที่อยู่ MAC ที่ระบุตัวตนสำหรับ ผู้โฆษณา (IFA) และที่ระบุตัวตนอื่นๆที่คล้ายคลึงกัน หรือตามแต่ที่ได้รับมอบหมาย</li>
                        <li>ระบบปฏิบัติการของอุปกรณ์และข้อเท็จจริงทางเทคนิคอื่นๆ</li>
                        <li>เมือง รัฐ และประเทศที่ท่านเข้าถึงเว็บไซต์ของเรา</li>
                        <li>หน้าที่เข้าเยี่ยมชม บทความที่เปิดดู บันทึก</li>
                        <li>ข้อมูลหรือข้อความที่กรอก หรือบันทึก</li>
                        <li>ลิงค์ หรือปุ่มที่กดเข้าไปดู</li>
                        <li>URLs ที่เข้าเยี่ยมชมก่อนหน้าและหลังจากใช้บริการของเรา</li>
                    </ul>
                </li>
            </ul>
        </div>
