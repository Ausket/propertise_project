    ...
    <section class="mt-6">
        ...
        <div class="container container-xxl mb-12">
            ...
            <div class="tables">
                ...
                <div class="rows-two">
                    <?php if (isset($_GET["id3"]) ? $_GET["id3"] : '') { ?>
                        <?php echo $row3['space_area'] ?> ตร.วา <?php } ?>
                </div>
