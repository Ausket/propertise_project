    ...
    <section class="pb-8 page-title shadow">
      <div class="container">
        <nav aria-label="breadcrumb">
          <h1 class="fs-30 lh-1 mb-0 text-heading font-weight-600"> ค้นหาอสังหาริมทรัพย์ </h1>
        </nav>
      </div>
    </section>
              ...
              <div class="card mb-4">
                <div class="card-body px-6 py-4">
                  ...
                  <form action="" method="GET">
                    ...
                    <div class="form-group">
                      <label for="location" class="sr-only">จังหวัด</label>
                      <select class="form-control border-0 shadow-none form-control-lg selectpicker" title="จังหวัด" data-style="btn-lg py-2 h-52" id="location" name="province">
                    ...
                    <div class="form-group">
                      <label for="type" class="sr-only">ประเภทอสังหา</label>
                      <select class="form-control border-0 shadow-none form-control-lg selectpicker" title="ประเภทอสังหา" data-style="btn-lg py-2 h-52" id="type" name="ptype">
                    ...
                    <div class="form-group">
                      <label for="status" class="sr-only">ประเภทประกาศ</label>
                      <select class="form-control border-0 shadow-none form-control-lg selectpicker" title="ประเภทประกาศ" data-style="btn-lg py-2 h-52" id="status" name="adtype">
                    ...
                    <div class="form-row mb-4">
                      <div class="col">
                        ...
                        <select class="form-control border-0 shadow-none form-control-lg selectpicker" title="ห้องนอน" data-style="btn-lg py-2 h-52" id="bed" name="bedroom">
                      ...
                      <div class="col">
                        ...
                        <select class="form-control border-0 shadow-none form-control-lg selectpicker" title="ห้องน้ำ" data-style="btn-lg py-2 h-52" id="baths" name="bathroom">
                          <option value="1">1 ห้อง</option>
                          <option value="2">2 ห้อง</option>
                          <option value="3">3 ห้อง</option>
                          <option value="4">4 ห้อง</option>
                    ...
                    <a class="lh-17 d-inline-block" data-toggle="collapse" href="#other-feature" role="button" aria-expanded="false" aria-controls="other-feature">
                      ...
                      <span class="fs-15 text-heading font-weight-500 hover-primary">สิ่งอำนวยความสะดวก</span>
                    </a>
                        ...
                        <ul class="list-group list-group-no-border">
                          <li class="list-group-item px-0 pt-0 pb-2">
                            <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="check1" name="facility[]" value="สระว่ายน้ำ">
                              <label class="custom-control-label" for="check1"> สระว่ายน้ำ </label>
                            </div>
                          </li>
                          <li class="list-group-item px-0 pt-0 pb-2">
                            <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="check2" name="facility[]" value="ร้านสะดวกซื้อ">
                              <label class="custom-control-label" for="check2"> ร้านสะดวกซื้อ </label>
                            </div>
                          </li>
                          <li class="list-group-item px-0 pt-0 pb-2">
                            <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="check3" name="facility[]" value="ห้องสมุด">
                              <label class="custom-control-label" for="check3"> ห้องสมุด </label>
                            </div>
                          </li>
                          <li class="list-group-item px-0 pt-0 pb-2">
                            <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="check4" name="facility[]" value="สนามเด็กเล่น">
                              <label class="custom-control-label" for="check4"> สนามเด็กเล่น </label>
                            </div>
                          </li>
                          <li class="list-group-item px-0 pt-0 pb-2">
                            <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="check5" name="facility[]" value="สวนสาธารณะ">
                              <label class="custom-control-label" for="check5"> สวนสาธารณะ </label>
                            </div>
                          </li>
                          <li class="list-group-item px-0 pt-0 pb-2">
                            <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="check6" name="facility[]" value="เครื่องปรับอากาศ">
                              <label class="custom-control-label" for="check6"> เครื่องปรับอากาศ </label>
                            </div>
                          </li>
                          <li class="list-group-item px-0 pt-0 pb-2">
                            <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="check7" name="facility[]" value="ฟิตเนส">
                              <label class="custom-control-label" for="check7"> ฟิตเนส </label>
                            </div>
                          </li>
                          <li class="list-group-item px-0 pt-0 pb-2">
                            <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="check8" name="facility[]" value="Wi-Fi">
                    ...
                    <button type="submit" name="submits" class="btn btn-primary btn-lg btn-block shadow-none mt-4"> ค้นหา </button>
                  </form>
                </div>
              </div>
            </div>
                ...
                <div class="col-md-6 mb-6" id="cardtwo">
                  <div class="card border-0" data-animate="fadeInUp" id="cardthree">
                    ...
                    <div class="card-body pt-3 px-0 pb-1">
                      <h2 class="fs-16 mb-1"> <a href="home-details.php?id=<?php echo $row2['a_id'] ?>" class="text-dark hover-primary"> <?php echo $row2['title'] ?> </a> </h2>
                    ...
                    <div class="card-footer bg-transparent px-0 pb-0 pt-2">
                      <ul class="list-inline mb-0">
                        <li class="list-inline-item text-gray font-weight-500 fs-13 mr-2" data-toggle="tooltip" title="3 Bedroom">
                          <svg class="icon icon-bedroom fs-18 text-primary mr-1">
                            <use xlink:href="#icon-bedroom"></use>
                          </svg>
                          <?php echo $row2['bedroom']; ?> ห้อง
                        </li>
                        <li class="list-inline-item text-gray font-weight-500 fs-13 mr-2" data-toggle="tooltip" title="3 Bathrooms">
                          <svg class="icon icon-shower fs-18 text-primary mr-1">
                            <use xlink:href="#icon-shower"></use>
                          </svg>
                          <?php echo $row2['bathroom']; ?> ห้อง
                        </li>
                        <li class="list-inline-item text-gray font-weight-500 fs-13 mr-2" data-toggle="tooltip" title="Size">
                          <svg class="icon icon-square fs-18 text-primary mr-1">
                            <use xlink:href="#icon-square"></use>
                          </svg>
                          <?php echo $row2['space_area']; ?> ตร.วา
                        </li>
                        <li class="list-inline-item text-gray font-weight-500 fs-13 mr-2" data-toggle="tooltip" title="1 Garage">
                          <svg class="icon icon-Garage fs-18 text-primary mr-1">
                            <use xlink:href="#icon-Garage"></use>
                          </svg>
                          <?php echo $row2['parking']; ?> คัน
                        </li>
                      </ul>
                    </div>
                  </div>
