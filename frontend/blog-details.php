...
<head>
  ...
  <meta name="twitter:title" content="Blog Details 2">
  <meta name="twitter:description" content="Real Estate Html Template">
  <meta name="twitter:image" content="images/homeid-social-logo.png">
  <!-- Facebook -->
  <meta property="og:url" content="blog-details-2.html">
  <meta property="og:title" content="Blog Details 2">
...
<body>
  ...
  <main id="content">
    <section class="pb-11 page-title">
      ...
      <div class="container">
        <ul class="list-inline text-center mb-3">
          <li class="list-inline-item">
            <a class="badge bg-gray-01 letter-spacing-1 text-body bg-hover-accent px-2"> <?php echo $rowa['a_type']; ?></a>
          </li>
        </ul>
