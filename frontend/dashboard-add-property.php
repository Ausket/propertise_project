                                ...
                                <div class="card mb-6">
                                  <div class="card-body p-6">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control form-control-lg border-0" id="project_name" name="project_name">
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <ul class="list-group list-group-no-border">
                                          <li class="list-group-item px-0 pt-0 pb-2">
                                            <div class="custom-control custom-checkbox">
                                              <input type="checkbox" class="custom-control-input" name="facility[]" id="attic" value="สระว่ายน้ำ">
                                              <label class="custom-control-label" for="attic"> สระว่ายน้ำ </label>
                                            </div>
                                          </li>
                                          <li class="list-group-item px-0 pt-0 pb-2">
                                            <div class="custom-control custom-checkbox">
                                              <input type="checkbox" class="custom-control-input" name="facility[]" id="basketball-court" value="ร้านสะดวกซื้อ">
                                      ...
                                      <div class="col-sm-6 col-lg-3">
                                        <ul class="list-group list-group-no-border">
                                          <li class="list-group-item px-0 pt-0 pb-2">
                                            <div class="custom-control custom-checkbox">
                                              <input type="checkbox" class="custom-control-input" name="facility[]" id="attic-01" value="ห้องสมุด">
                                              <label class="custom-control-label" for="attic-01"> ห้องสมุด </label>
                                            </div>
                                          </li>
                                          <li class="list-group-item px-0 pt-0 pb-2">
                                            <div class="custom-control custom-checkbox">
                                              <input type="checkbox" class="custom-control-input" name="facility[]" id="basketball-court-01" value="สนามเด็กเล่น">
                                      ...
                                      <div class="col-sm-6 col-lg-3">
                                        <ul class="list-group list-group-no-border">
                                          <li class="list-group-item px-0 pt-0 pb-2">
                                            <div class="custom-control custom-checkbox">
                                              <input type="checkbox" class="custom-control-input" name="facility[]" id="attic-02" value="สวนสาธารณะ">
                                              <label class="custom-control-label" for="attic-02"> สวนสาธารณะ </label>
                                            </div>
                                          </li>
                                          <li class="list-group-item px-0 pt-0 pb-2">
                                            <div class="custom-control custom-checkbox">
                                              <input type="checkbox" class="custom-control-input" name="facility[]" id="basketball-court-02" value="เครื่องปรับอากาศ">
                                      ...
                                      <div class="col-sm-6 col-lg-3">
                                        <ul class="list-group list-group-no-border">
                                          <li class="list-group-item px-0 pt-0 pb-2">
                                            <div class="custom-control custom-checkbox">
                                              <input type="checkbox" class="custom-control-input" name="facility[]" id="attic-03" value="ฟิตเนส">
                                              <label class="custom-control-label" for="attic-03"> ฟิตเนส </label>
                                            </div>
                                          </li>
                                          <li class="list-group-item px-0 pt-0 pb-2">
                                            <div class="custom-control custom-checkbox">
                                              <input type="checkbox" class="custom-control-input" name="facility[]" id="basketball-court-03" value="Wi-Fi">
                                    ...
                                    <div class="form-row mx-n2">
                                      <div class="col-md-6 col-lg-12 col-xxl-6 px-2">
                                        <div class="form-group">
                                          ...
                                          <input type="text" class="form-control form-control-lg border-0" id="lane" name="lane">
                                        </div>
                                      </div>
                                      <div class="col-md-6 col-lg-12 col-xxl-6 px-2">
                                        <div class="form-group">
                                          <label for="zip" class="text-heading"> ถนน </label>
                                          <input type="text" class="form-control form-control-lg border-0" id="road" name="road">
                                        </div>
                                      </div>
                                    </div>
