              ...
              <div class="col-sm-6 col-xxl-3 mb-6">
                <div class="card">
                  <div class="card-body row align-items-center px-6 py-7">
                    ...
                    <div class="col-7 text-center">
                      <p class="fs-42 lh-12 mb-0 counterup" data-start="0" data-end="<?php echo $numf ?>" data-decimals="0" data-duration="0" data-separator=""><?php echo $numf ?></p>
                      <p>รายการโปรดทั้งหมด</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card px-7 py-6 h-100 chart">
                  <div class="card-body p-0 collapse-tabs">
                    <div class="d-flex align-items-center mb-5">
                      <h2 class="mb-0 text-heading fs-22 lh-15 mr-auto">ดูสถิติ</h2>
                      <ul class="nav nav-pills justify-content-end d-none d-sm-flex nav-pills-01" role="tablist">
                        <li class="nav-item px-5 py-1">
                          <a class="nav-link active bg-transparent shadow-none p-0 letter-spacing-1" id="hours-tab" data-toggle="tab" href="#hours" role="tab" aria-controls="Hours" aria-selected="true">ชั่วโมง</a>
                        </li>
                        <li class="nav-item px-5 py-1">
                          <a class="nav-link bg-transparent shadow-none p-0 letter-spacing-1" id="weekly-tab" data-toggle="tab" href="#weekly" role="tab" aria-controls="Weekly" aria-selected="false">สัปดาห์</a>
                        </li>
                        <li class="nav-item px-5 py-1">
                          <a class="nav-link bg-transparent shadow-none p-0 letter-spacing-1" id="monthly-tab" data-toggle="tab" href="#monthly" role="tab" aria-controls="Monthly" aria-selected="false">เดือน</a>
                        </li>
                      </ul>
                    </div>
