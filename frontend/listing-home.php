...
<head>
  ...
  <!-- Facebook -->
  <meta property="og:url" content="listing-half-map-list-layout-2.html">
...
<body>
  ...
  <main id="content">
        ...
        <form class="property-search d-none d-lg-block">
          <div class="row align-items-lg-center" id="accordion-2">
            ...
            <div class="col-xl-8 col-lg-7 d-md-flex">
              <select class="form-control shadow-none form-control-lg selectpicker rounded-right-md-0 rounded-md-top-left-0 rounded-lg-top-left flex-md-1 mt-3 mt-md-0" title="ประเภทอสังหาริมทรัพย์" data-style="btn-lg py-2 h-52 border-right bg-white" id="type-1" name="type">
                <option>คอนโดมิเนียม</option>
                <option>บ้านเดี่ยว</option>
                <option>ทาวน์เฮ้าส์</option>
                <option>บ้านหลายครอบครัว</option>
              </select>
            ...
            <div id="advanced-search-filters-2" class="col-12 pb-6 pt-lg-2 collapse" data-parent="#accordion-2">
              <div class="row mx-n2">
                <div class="col-sm-6 col-md-4 col-lg-3 pt-4 px-2">
                  <select class="form-control border-0 shadow-none form-control-lg selectpicker bg-white" name="status" title="Status" data-style="btn-lg py-2 h-52 bg-white">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 pt-4 px-2">
                  <select class="form-control border-0 shadow-none form-control-lg selectpicker bg-white" name="areas" title="All Areas" data-style="btn-lg py-2 h-52 bg-white">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 pt-4 px-2">
                  <input type="text" class="form-control form-control-lg border-0 shadow-none bg-white" placeholder="Property ID" name="property-id">
                </div>
              </div>
              <div class="row">
                ...
                <div class="col-md-6 col-lg-5 pt-6 slider-range slider-range-primary offset-lg-1">
                  ...
                  <div data-slider="true" data-slider-options='{"min":0,"max":15000,"values":[0,12000],"type":"currency"}'></div>
                  <div class="text-center mt-2">
                ...
                <div class="collapse row mx-0 w-100" id="other-feature-2">
                  ...
                  <div class="col-sm-6 col-md-4 col-lg-3 py-2">
                    <div class="custom-control custom-checkbox">
                      ...
                      <label class="custom-control-label text-white" for="check16-2">Refrigerator</label>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div id="advanced-search-filters-2-mobile" class="col-12 pt-2 collapse" data-parent="#accordion-2-mobile">
              <div class="row mx-n2">
                <div class="col-sm-6 pt-4 px-2">
                  <select class="form-control border-0 shadow-none form-control-lg selectpicker bg-white" title="Select" data-style="btn-lg py-2 h-52 bg-white" name="type">
                    <option>All status</option>
                    <option>For Rent</option>
                    <option>For Sale</option>
                  </select>
              ...
              <div class="row">
                <div class="col-md-6 pt-6 slider-range slider-range-primary">
                  ...
                  <div data-slider="true" data-slider-options='{"min":0,"max":1000000,"values":[100000,700000],"type":"currency"}'></div>
                  <div class="text-center mt-2">
                    <input id="price-2-mobile" type="text" readonly class="border-0 amount text-center text-white bg-transparent font-weight-500" name="price">
                  </div>
                </div>
                <div class="col-md-6 pt-6 slider-range slider-range-primary">
                  ...
                  <div class="text-center mt-2">
                    <input id="area-size-2-mobile" type="text" readonly class="border-0 amount text-center text-white bg-transparent font-weight-500" name="area">
                  </div>
                </div>
                <div class="col-12 pt-4 pb-2">
                  <a class="lh-17 d-inline-block other-feature collapsed" data-toggle="collapse" href="#other-feature-2-mobile" role="button" aria-expanded="false" aria-controls="other-feature-2-mobile">
                    <span class="fs-15 text-white font-weight-500 hover-primary">Other Features</span>
                  </a>
                </div>
      ...
      <div class="container-fluid px-xxl-8">
        <form class="form-inline" id="accordion-5">
          <div class="form-group p-1">
            ...
            <select class="form-control border-0 shadow-xxs-1 bg-transparent font-weight-600 selectpicker" title="Location" data-style="bg-white" id="location-2" name="location">
          ...
          <div class="form-group p-1">
            ...
            <select class="form-control border-0 shadow-xxs-1 bg-transparent font-weight-600 selectpicker" title="Any Price" data-style="bg-white" id="any-price" name="any-price">
              <option>1</option>
              <option>2</option>
            </select>
          </div>
          <div class="form-group p-1">
            ...
            <select class="form-control border-0 shadow-xxs-1 bg-transparent font-weight-600 selectpicker" title="Type" data-style="bg-white" id="type" name="type">
          ...
          <div class="form-group p-1">
            ...
            <select class="form-control border-0 shadow-xxs-1 bg-transparent font-weight-600 selectpicker" title="All status" data-style="bg-white" id="status" name="status">
              <option>All status</option>
              <option>For Rent</option>
              <option>For Sale</option>
            </select>
          ...
          <div class="form-group p-1">
            ...
            <select class="form-control border-0 shadow-xxs-1 bg-transparent font-weight-600 selectpicker" title="Area" data-style="bg-white" id="area" name="areas">
              <option>hotel</option>
              <option>motel</option>
            </select>
          </div>
          ...
          <div id="advanced-search-filters-5" class="row pb-6 pt-2 collapse p-1 w-100" data-parent="#accordion-5">
            <div class="col-sm-6 col-md-4 col-lg-3 py-2">
              <div class="custom-control custom-checkbox">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 py-2">
              <div class="custom-control custom-checkbox">
                ...
                <label class="custom-control-label justify-content-start" for="check5-5">Barbeque</label>
              </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg-3 py-2">
              <div class="custom-control custom-checkbox">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 py-2">
              <div class="custom-control custom-checkbox">
                ...
                <label class="custom-control-label justify-content-start" for="check10-5">Microwave</label>
              </div>
            </div>
            <div class="col-sm-6 col-md-4 col-lg-3 py-2">
              <div class="custom-control custom-checkbox">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 py-2">
              <div class="custom-control custom-checkbox">
                ...
                <label class="custom-control-label justify-content-start" for="check16-5">Refrigerator</label>
              </div>
            </div>
          </div>
        </form>
    ...
    <div class="d-none" id="template-properties">
      ...
      <div class="marker-item" data-icon-marker="../images/googlle-market-03.png" data-position="[-73.9947227, 40.6734035]" data-marker-style='{"className":"marker","style":{"width":"45px","height":"48px"},"popup":{"className":"popup-map-property-02","maxWidth":"319px"}}'>
        <div class="position-relative">
          <div class="media flex-row no-gutters align-items-center pb-2 border-bottom p-2">
      ...
      <div class="marker-item" data-icon-marker="../images/googlle-market-02.png" data-position="[-73.9968864, 40.6747657]" data-marker-style='{"className":"marker","style":{"width":"45px","height":"48px"},"popup":{"className":"popup-map-property-02","maxWidth":"319px"}}'>
        <div class="position-relative">
          <div class="media flex-row no-gutters align-items-center pb-2 border-bottom p-2">
      ...
      <div class="marker-item" data-icon-marker="../images/googlle-market-02.png" data-position="[-73.9929114, 40.6731454]" data-marker-style='{"className":"marker","style":{"width":"45px","height":"48px"},"popup":{"className":"popup-map-property-02","maxWidth":"319px"}}'>
        <div class="position-relative">
          <div class="media flex-row no-gutters align-items-center pb-2 border-bottom p-2">
      ...
      <div class="marker-item" data-icon-marker="../images/googlle-market-03.png" data-position="[-73.9927934, 40.674364]" data-marker-style='{"className":"marker","style":{"width":"45px","height":"48px"},"popup":{"className":"popup-map-property-02","maxWidth":"319px"}}'>
        <div class="position-relative">
          <div class="media flex-row no-gutters align-items-center pb-2 border-bottom p-2">
            <div class="col-3 mr-2 card border-0"><img src="../images/properties-list-03.jpg" class="card-img" alt="Home in Metric Way"></div>
            <div class="media-body">
