...
<section class="CookiePolicy">
    <div class="container mt-6 mb-6">
        <header class="PolicyHeader">
            <h1> นโยบายความเป็นส่วนตัวของบริการเว็บไซต์ Home ID </h1>
        </header>
        <p class="mt-4">Home ID  ให้คุณค่ากับความเป็นส่วนตัวของท่าน นโยบายในความเป็นส่วนตัวฉบับนี้จะบอกทางเลือกของท่านและการดำเนินการของเราเกี่ยวกับข้อมูลที่ท่านให้กับเรา</p>
        <p>การใช้บริการของเราอาจเกี่ยวข้องกับการเก็บรวบรวมและใช้ข้อมูลของท่าน (ตามที่กำหนดไว้ในหัวข้อ “ข้อมูลที่เราเก็บรวบรวมและเราเก็บรวบรวมอย่างไร” ด้านล่างนี้) บนบริการของเรา (รวมถึงเว็บไซต์และโมบายแอพพลิเคชั่นของเรา) ทั้งนี้ เป็นเรื่องที่มีความจำเป็นที่ท่านจะต้องเข้าใจว่าเรื่องเหล่านี้ดำเนินการอย่างไรและท่านจะสามารถควบคุมได้อย่างไร ดังนั้น ขอให้ท่านกรุณาอ่านนโยบายในความเป็นส่วนตัวฉบับนี้ด้วยความระมัดระวัง</p>
        <h2 class="PolicyTitle mt-6">ช่องทางการติดต่อเรา</h2>
        <p class="mt-4">ในกรณีที่ท่านประสงค์จะติดต่อเราเกี่ยวกับนโยบายในความเป็นส่วนตัวฉบับนี้ หรือเรื่องใดๆ ที่เกี่ยวกับความเป็นส่วนตัว กรุณาติดต่อเราได้ที่เจ้าหน้าที่ดูแลความเป็นส่วนตัวของเราทางอีเมล์
            <!-- --> <a href="Home_ID@gmail.com?Subject=ติดต่อเกี่ยวกับนโยบายในความเป็นส่วนตัว" title="ติดต่อเกี่ยวกับนโยบายในความเป็นส่วนตัว">Home_ID@gmail.com</a> <!-- -->ฝ่ายดูแลข้อมูลส่วนบุคคล โทร 02-1016841 หรือผ่านทางไปรษณีย์มาที่ 44/170 ปริญลักษณ์เพชรเกษม 69 ถนนเลียบฯ ฝั่งเหนือ หนองแขม, หนองแขม, กรุงเทพมหานคร, 10160 (ส่งถึง ฝ่ายดูแลข้อมูลส่วนบุคคล)
        </p>
        <h2 class="PolicyTitle mt-6">การเปลี่ยนแปลงนโยบายความเป็นส่วนตัวฉบับนี้</h2>
        <p class="mt-4">นโยบายความเป็นส่วนตัวนี้อาจถูกเปลี่ยนแปลงแก้ไขได้เป็นครั้งคราว หากมีการเปลี่ยนแปลงหรือเพิ่มเติมวิธีการใช้ ประมวลผลข้อมูลส่วนบุคคลของท่านตามที่ระบุไว้นี้ส่งผลกระทบต่อท่าน ท่านจะได้รับการติดต่อผ่านช่องทางที่เหมาะสม ยกตัวอย่างเช่น เราอาจจะแจ้งเตือนให้ท่านทราบอย่างชัดเจนบนหน้าบริการหรือส่งอีเมล์ให้ท่านทราบถึงการเปลี่ยนแปลงดังกล่าว</p>
        <h2 class="PolicyTitle mt-6">1. ข้อมูลที่เราเก็บรวบรวมและเราเก็บรวบรวมข้อมูลอย่างไร</h2>
        <p class="mt-4">ในการให้บริการของเรา เราได้เก็บรวบรวม เก็บรักษาและใช้ข้อมูลของท่านดังต่อไปนี้</p>
        <p><strong>“ข้อมูล”</strong> ได้แก่ ข้อมูลส่วนบุคคล และข้อมูลที่มิใช่ข้อมูลส่วนบุคคล</p>
        <p><strong>"ข้อมูลส่วนบุคคล"</strong> ได้แก่ ข้อมูล หรือการรวมกันของข้อมูลซึ่งเกี่ยวกับท่านและสามารถใช้ระบุตัวตนของท่านได้ โดยที่ข้อมูลส่วนบุคคล อาจรวมถึงข้อมูลดังต่อไปนี้</p>
        <ul>
            <li>ข้อมูลที่ท่านให้แก่เราเมื่อมีการเปิดบัญชีหรือใช้บริการของเรา เช่น ชื่อ หมายเลขโทรศัพท์ อีเมล์แอดเดรส และข้อมูลบัตรเครดิต</li>
            <li>ข้อมูลที่ท่านใช้กับบริการของเรา รวมถึง ข้อมูลที่แบ่งปันร่วมกันที่ท่านจัดส่งให้แก่บุคคลอื่นๆ ผ่านทางบริการของเราและข้อมูลที่ท่านเก็บรักษาโดยใช้บริการของเรา</li>
            <li>ข้อมูลที่แบ่งปันร่วมกันกับผู้อื่นที่ใช้บริการของเราที่ได้จัดส่งให้แก่เรา เช่น ข้อมูลที่ระบุในกระทู้ที่มีการตั้ง และการติดต่อสื่อสารกับท่านและผู้อื่นที่ใช้บริการของเรา และ</li>
            <li>ข้อมูลที่เราเก็บรวบรวมจากการที่ท่านใช้บริการของเรา เช่นข้อมูลเกี่ยวกับตำแหน่งพื้นที่บางแห่ง ข้อมูลเกี่ยวกับการใช้บริการ และข้อมูลสาธารณะ</li>
        </ul>
        <p><strong>“ข้อมูลเกี่ยวกับตำแหน่งพื้นที่”</strong> ได้แก่ ข้อมูลที่เราเก็บรวบรวมเกี่ยวกับตำแหน่งพื้นที่ของท่าน (เมื่อท่านมีการเปิดใช้บริการเกี่ยวกับตำแหน่งพื้นที่) ซึ่งรวมถึง:</p>
        <ul>
            <li>ตำแหน่งพื้นที่ของอุปกรณ์ของท่านเมื่อท่านใช้บริการของเรา เช่น ข้อมูลจาก GPS WiFi เข็มทิศ เครื่องวัดความเร่ง หรือการตรวจจับการเคลื่อนไหวอื่นในอุปกรณ์ของท่าน</li>
            <li>ไอพีแอดเดรสของอุปกรณ์หรือบริการทางอินเตอร์เน็ตที่ท่านใช้ในการเข้าถือบริการของเรา</li>
            <li>ข้อมูลอื่นๆ ที่ท่านจัดส่งให้กับเราหรือบุคคลอื่นซึ่งทำให้สามารถระบุตำแหน่งของท่าน หรือสถานที่ที่ท่านอยู่ได้ และข้อมูลที่แบ่งปันร่วมกันที่ท่านหรือบุคคลอื่นระบุซึ่งสามารถบ่งชี้ตำแหน่งพื้นที่ของท่านได้ เช่น ข้อมูลพิกัดตำแหน่งที่ได้ติดตั้งอยู่ในรูปภาพที่ท่านส่งมายังเรา และ</li>
            <li>ในกรณีที่ท่านได้ส่งข้อมูลเกี่ยวกับตำแหน่งพื้นที่ของท่านให้กับเราไว้ก่อนหน้านี้ และประสงค์จะให้เราลบข้อมูลดังกล่าวออก ท่านสามารถดำเนินการได้ผ่านทางบริการของเรา</li>
        </ul>
        <p><strong>"ข้อมูลเกี่ยวกับการเข้าใช้บริการ"</strong> ได้แก่ ข้อมูลทางเทคนิคที่เรามีการเก็บรวบรวมโดยอัตโนมัติเมื่อท่านใช้บริการของเรา ไม่ว่าจะผ่านทางการใช้งานหรือทางคุกกี้ (ตามที่จะมีการอธิบายในรายละเอียดใน
            <!-- --> <strong>นโยบายเกี่ยวกับคุกกี้</strong>) หรือข้อมูลอื่นๆ ซึ่งรวมถึง:
        </p>
        <ul>
            <li>ข้อมูลทางเทคนิค เช่น ผู้ให้บริการโทรศัพท์เคลื่อนที่ของท่าน ข้อมูลการตั้งค่าที่ส่งให้แก่เราโดยเว็บเบราเซอร์หรือโปรแกรมอื่นๆ ซึ่งท่านใช้ในการเข้าถึงบริการของเรา ไอพีแอดเดรสของท่าน เวอร์ชั่นและเลขทะเบียนของอุปกรณ์ของท่าน</li>
            <li>ข้อมูลเกี่ยวกับการสืบค้นและการรับชมในขณะที่ท่านใช้บริการของเรา เช่น คำสืบค้นที่ได้ใช้ บัญชีโซเชียลมีเดียที่ท่านเข้าชม ข้อมูลและเนื้อหาอื่นๆ ที่เกี่ยวข้อง ซึ่งเข้าถึงหรือมีการส่งคำร้องขอจากท่านในการใช้บริการของเรา</li>
            <li>ข้อมูลเกี่ยวกับ whatapps และซอฟต์แวร์อื่นๆ ซึ่งท่านใช้และวิธีการที่ท่านใช้ซอฟต์แวร์เหล่านั้น</li>
            <li>ข้อมูลเกี่ยวกับการติดต่อสื่อสารซึ่งท่านใช้ในบริการของเรา เช่น บุคคลซึ่งท่านได้มีการติดต่อสื่อสารด้วย และเวลา รวมถึง ระยะเวลาที่ท่านติดต่อสื่อสารด้วย และข้อมูลกำกับ(metadata) ซึ่งหมายถึงข้อมูลที่เกี่ยวข้องกับรายการที่ท่านได้ใช้ผ่านบริการของเราเช่น วันที่ เวลาหรือตำแหน่งพื้นที่ซึ่งรูปภาพหรือวีดีโอที่ได้ทำการแบ่งปันข้อมูลมานั้นได้ถูกทำขึ้นหรือโพสต์ไว้</li>
        </ul>
        <p><strong>“ข้อมูลที่ไม่ใช่ข้อมูลส่วนบุคคล”</strong> ได้แก่ ข้อมูลใดๆ ที่เกี่ยวข้องกับท่านแต่ไม่สามารถใช้ในการระบุตัวตนของท่านไม่ว่าโดยตรงหรือโดยอ้อม รวมถึงข้อมูลส่วนบุคคลในรูปแบบของข้อมูลสรุปหรือไม่มีการเปิดเผยขื่อ หรือเป็นนามปากกา</p>
        <p><strong>“ข้อมูลที่แบ่งปันร่วมกัน”</strong> <!-- -->ได้แก่ข้อมูลเกี่ยวกับท่านหรือเกี่ยวข้องกับท่านซึ่งได้มีการแบ่งปันในบริการของเราอย่างสมัครใจ รวมถึงการโพสต์ข้อมูลซึ่งท่านใช้ในบริการของเรา (รวมถึงโปรไฟล์สาธารณะของท่านและรายการที่ท่านสร้างขึ้น) ข้อมูลการโพสต์ของบุคคลอื่น ซึ่งท่านได้นำไปโพสต์ซ้ำรวมไปถึงข้อมูลเกี่ยวกับตำแหน่งพื้นที่และข้อมูลเกี่ยวกับการเข้าใช้บริการที่เกี่ยวข้องกับการโพสต์ดังกล่าว ทั้งนี้ ข้อมูลที่แบ่งปันร่วมกันยังรวมไปถึงข้อมูลเกี่ยวกับท่าน (ยังรวมไปถึงข้อมูลเกี่ยวกับตำแหน่งพื้นที่และข้อมูลเกี่ยวกับการเข้าใช้บริการ)ซึ่งผู้อื่นที่ได้ใช้บริการของเราได้แบ่งปันข้อมูลดังกล่าวเกี่ยวกับท่าน</p>
        <h2 class="PolicyTitle mt-6">2. เราใช้ข้อมูลของท่านอย่างไร</h2>
        <p class="mt-4">เราอาจใช้ข้อมูลของท่านเพื่อวัตถุประสงค์ดังต่อไปนี้:</p>
        <ul>
            <li>เพื่อให้บริการของเราแก่ท่าน</li>
            <li>เพื่อวัตถุประสงค์ในการให้บริการแก่ลูกค้า ความปลอดภัย การตรวจสอบการทุจริต คลังข้อมูลและการสำรองข้อมูลที่เกี่ยวข้องกับการให้บริการของเรา</li>
            <li>เพื่อการโฆษณาแก่ท่าน (ตามที่ปรากฏรายละเอียดเพิ่มเติมภายใต้หัวข้อ”การโฆษณาและการตลาด”ด้านล่างนี้)</li>
            <li>เพื่อใช้ในการทำความเข้าใจให้ดีว่าท่านเข้าถึงและใช้บริการของเราอย่างไร และเพื่อวัตถุประสงค์ในการปรับปรุงบริการของเรา รวมถึงการดำเนินการตามความประสงค์และความชื่นชอบของลูกค้าอีกทั้งเพื่อการปรับแต่งภาษาและตำแหน่งพื้นที่ การให้ความช่วยเหลือและการชี้แจ้งที่ทำให้เป็นลักษณะส่วนบุคคล หรือการดำเนินการอื่นๆที่เกี่ยวข้องกับการใช้บริการของท่านและลูกค้ารายอื่นๆ</li>
            <li>เพื่อช่วยเราพัฒนาบริการใหม่ๆและปรับปรุงบริการที่มีอยู่แล้ว</li>
            <li>เพื่อทำให้การปรับปรุงโฆษณาและการทำกิจกรรมทางการตลาด กิจกรรมทางการส่งเสริมการขายที่มีอยู่ใน หรือเกี่ยวข้องกับบริการของเราเป็นไปโดยมีประสิทธิภาพมากยิ่งขึ้น</li>
            <li>เพื่อวัตถุประสงค์ในการตรวจสอบซอฟต์แวร์หรือบริหารการปรับปรุงซอฟต์แวร์ และ</li>
            <li>เพื่อให้ท่านสามารถเข้าร่วมในการสำรวจและกิจกรรมอื่นๆเกี่ยวกับผลิตภัณฑ์และบริการของเรา</li>
        </ul>
        <p>โปรดสังเกตว่าในกระบวนการที่เราจะให้บริการแก่ผู้ใช้เพื่อให้ได้รับประสบการณ์ที่ดีกว่า หรือเพื่อปรับปรุงบริการของเรา ข้อมูลส่วนบุคคล(ในกรณีที่ท่านให้ความยินยอมไว้)ที่ได้เก็บรวบรวมผ่านบริการใดๆของเราอาจจะอยู่ภายใต้การดำเนินการควบคุมความเป็นส่วนตัวโดยผู้ใช้เอง (ในกรณีที่ทำได้) ซึ่งใช้กับบริการอื่นๆของเรา (รวมถึงการดำเนินการในลักษณะของการสรุปข้อมูลหรือทำให้ข้อมูลหรือการทำข้อมูลเป็นรายบุคคลด้วย) </p>
        <p>ยกตัวอย่างเช่น ข้อมูลส่วนบุคคลที่เก็บรวบรวมระหว่างการใช้บริการใดๆ ของท่านอาจมีการนำไปดำเนินการเพื่อคำแนะนำในเนื้อหาใดๆ เป็นการเฉพาะเพื่อแนะนำบริการอื่นๆให้แก่ท่านหรืออาจนำไปใช้เพื่อการโฆษณาที่เกี่ยวข้องแก่ท่านในบริการอื่น ทั้งนี้ท่านอาจจะร้องขอให้เราย้ายหรือจัดส่งข้อมูลส่วนบุคคลของท่านจากบริการใดบริการหนึ่งของเราไปยังบริการอื่นๆของเราในกรณีที่มีช่องทางให้สามารถทำการย้ายข้อมูลดังกล่าวได้ </p>
        <h2 class="PolicyTitle mt-6">3. สิทธิของท่าน</h2>
        <p class="mt-4">ท่านอาจมีสิทธิภายใต้กฎหมายไทย หรือกฎหมายอื่นในการเข้าถึงข้อมูลส่วนบุคคลของท่าน และร้องขอที่จะแก้ไข ลบ หรือจำกัดการใช้ข้อมูลของท่าน ท่านมีสิทธิที่จะคัดค้านการใช้ ร้องขอให้ถ่ายโอนไป หรือเพิกถอนความยินยอมในการใช้ข้อมูลส่วนบุคคลของท่าน กรุณาศึกษาข้อมูลเพื่มเติมสำหรับการใช้สิทธิของท่านด้านล่างนี้ </p>
        <p>เราจะเคารพสิทธิของท่านภายใต้กฎหมายคุ้มครองข้อมูลส่วนบุคคล คุณมีสิทธิตามที่ระบุไว้ด้านล่างนี้ภายใต้กฎหมายไทย และอาจมีสิทธิที่เหมือนกันนี้ภายใต้กฎหมายอื่นๆ</strong></p>
        <ul>
            <li>สิทธิในการเข้าถึงข้อมูล กล่าวคือท่านมีสิทธิที่จะเขียนคำร้องเพื่อขอทราบถึงข้อมูลส่วนบุคคลที่ถูกจัดเก็บ และขอรับสำเนาข้อมูลส่วนบุคคลที่ถูกจัดเก็บไว้</li>
            <li>สิทธิในการขอแก้ไข กล่าวคือท่านมีสิทธิที่จะร้องขอให้ลบข้อมูลส่วนบุคคลที่ไม่ถูกต้องและดำเนินการแก้ไขให้ถูกต้อง</li>
            <li>สิทธิในการลบข้อมูล (สิทธิที่จะถูกลืม) คือ สิทธิในการที่จะลบข้อมูลส่วนบุคคลของท่านออกจากบริการ</li>
            <li>สิทธิในการอนุญาตให้ใช้อย่างจำกัด กล่าวคือ สิทธิที่จะร้องขอให้ใช้ข้อมูลส่วนบุคคลของท่านอย่างจำกัดตามวัตถุประสงค์ที่ระบุไว้เฉพาะ</li>
            <li>สิทธิในการยกเลิกประชาสัมพันธ์ด้านการตลาด กล่าวคือท่านสามารถบริหารจัดการด้านการประชาสมพันธ์การตลาดได้ด้วยตนเองที่การยกเลิกการสื่อสารของเราที่ส่งถึงท่าน หรือเข้าไปยกเลิก ณ ศูนย์กลางที่ดูแลจัดการด้านการตลาดที่บังคับใช้อยู่ในบริการของเรา</li>
            <li>สิทธิในการคัดค้าน กล่าวคือ ท่านมีสิทธิที่จะคัดค้านการใช้ข้อมูลส่วนบุคคลของท่าน ในกรณีที่ข้อมูลส่วนบุคคลของท่านถูกนำไปใช้เพื่อประโยชน์สาธารณะ หรือในกรณีที่เราให้ท่านทราบถึงการใช้ข้อมูลส่วนบุคคลของท่านในรูปแบบสิทธิตามกฎหมายของเราหรือของบุคคลภายนอก</li>
            <li>สิทธิในการร้องขอให้ถ่ายโอน คือ สิทธิทีจะร้องขอให้ถ่ายโอนข้อมูลส่วนบุคคลของท่านที่เราจัดเก็บไปยังผู้ให้บริการอื่น หรือบริการอื่น</li>
            <li>สิทธิในการเพิกถอนความยินยอม คือ สิทธิที่ท่านจะเพิกถอนความยินยอม ณ เวลาใดๆ ที่ท่านเคยไว้ก่อนหน้านี้แก่เราในการใช้ จัดการข้อมูลส่วนบุคคลของท่าน ถ้าคุณเพิกถอนความยินยอมที่ให้ไว้แก่เรา จะไม่ส่งผลถึงการใดๆก่อนหน้าที่เราได้ใช้ และประมวลผลข้อมูลส่วนบุคคลของท่านโดยอ้างสิทธิตามกฎหมาย</li>
        </ul>
        <p>สิทธิดังกล่าวข้างต้นไม่ใช่สิทธิเด็ดขาดและไม่สามารถปรับใช้ได้ทุกกรณี</p>
        <p>ในการตอบสนองคำร้องขอ เราอาจจะร้องขอให้ท่านยืนยันตัวตนหากจำเป็น และจัดหาข้อมูลเท่าที่จำเป็นเพื่อให้เราเข้าใจคำร้องขอของท่านมากยิ่งขึ้น หากเราไม่สามารถปฏิบัติตามคำร้องขอของท่านได้ไม่ว่าทั้งหมดหรือบางส่วน เราจะแจ้งให้ท่านทราบถึงเหตุผลดังกล่าว</p>
        <p>ในการใช้สิทธิของท่าน โปรดติดต่อผู้ดูแลข้อมูลส่วนบุคคลตามช่องทางการติดต่อที่แจ้งไว้ทางด้านบน</p>
        <h2 class="PolicyTitle mt-6">4. คุกกี้ เว็บบีคอนและเทคโนโลยีที่คล้ายคลึงกัน</h2>
        <p class="mt-4">กรุณาตรวจสอบข้อมูลเพิ่มเติมใน<strong>นโยบายเกี่ยวกับคุกกี้ของเรา</strong> <!-- -->ในเรื่องที่เกี่ยวกับว่าเราใช้คุกกี้ เว็ปบีคอนและเทคโนโลยีที่คล้ายคลึงกันอย่างไร</p>
        <h2 class="PolicyTitle mt-6">5. การโฆษณาและการตลาด</h2>
        <p class="mt-4">เราอาจใช้ข้อมูลของท่านเพื่อจัดส่งโฆษณาที่เกี่ยวข้องกับคุณผ่านช่องทางต่างๆ เช่น อีเมล์ โทรศัพท์ ข้อความ หรือสื่อออนไลน์ อย่างไรก็ตามเราจะให้ท่านเป็นผู้เลือกตามที่กฎหมายกำหนดอย่างชัดเจนว่าท่านตกลงที่จะรับข้อความสื่อสารด้านการตลาดกับเราหรือไม่ในกรณีที่เราประชาสัมพันธ์ด้านการตลาดไปยังท่าน ข้อความดังกล่าวจะระบุวิธ๊ยกเลิกการรับข้อความในอนาคตให้ท่านทราบด้วย</p>
        <p>เราเคารพสิทธิในการเลือกที่จะรับการประชาสัมพันธ์ด้านการตลาดของท่าน ท่านมีสิทธิที่จะยกเลิกการรับการประชาสัมพันธ์ด้านการตลาดโดยตรงและตัวเลือกโฆษณาออนไลน์</p>
        <p>วิธียกเลิกการรับการประชาสมพันธ์การตลาดผ่านอีเมล์</p>
        <p>ในกรณีที่เราส่งอีเมล์ประชาสัมพันธ์การตลาดถึงท่าน เราจะจัดหาช่องทางให้ท่านยกเลิกการรับข้อความดังกล่าวบนอีเมล์นั้นๆ เพื่อที่จะปรับปรุงตัวเลือกากรโฆษณาบนอีเมล์ของท่าน กรุณาไปที่การตั้งค่าอีเมล์ที่ท่านใช้อยู่ นอกจากนี้ท่านยังสามารถติดต่อมาอย่างเราผ่านช่องทางติดต่อเราบนแต่ละบริการเพื่อพูดคุยกับเรา</p>
        <p>อย่างไรก็ตาม แม้ว่าท่านจะยกเลิกการรับการประชาสัมพันธ์ด้านการตลาดผ่านอีเมล์ เราอาจจะยังติดต่อไปถึงท่านเกี่ยวกับบริการของเราหรือข้อมูลสำคัญที่เกี่ยวกับบัญชีผู้ใช้ของท่านและการสมัครสมาชิก (เพื่อวัตถุประสงค์ในการดูแลลูกค้า)</p>
        <p>โฆษณาตามความสนใจ หรือไอบีเอ Interest-based advertising (IBA)</p>
        <p>ไอบีเออนุญาตให้เราสามารถส่งโฆษณาที่ท่านสนใจบนบริการของเรา ไอบีเอทำงานโดยแสดงโฆษณาให้ท่านหรือส่งอีเมล์ด้านการตลาดไปยังท่านโดยพิจารณาจากบทความที่ท่านอ่านหรือเข้าถึง ยกตัวอย่างเช่น เมื่อท่านเข้ามาใช้บริการของเรา คุกกี้ที่วางอยู่บนอุปกรณ์ของท่านคือ คุกกี้ที่เกี่ยวกับการโฆษณาซึ่งจะทำให้เราเข้าใจว่าหน้าไหนหรือบทความไหนที่ท่านสนใจ ข้อมูลที่ถูกจัดเก็บบนอุปกรณ์ของท่านช่วยให้เราสามารถจัดกลุ่มกับอุปกรณ์อื่นๆที่สนใจในเรื่องเดียวกัน โดยเราสามารถแสดงโฆษณาให้ท่านบนพื้นฐานที่ท่านสนใจ สำหรับข้อมูลเพิ่มเติมเกี่ยวกับไอบีเอ กรุณาติดต่อที่
            <!-- --> <a href="http://www.iab.net/public_policy/behavioral-advertisingprinciples." title="" target="_blank">http://www.iab.net/public_policy/behavioral-advertisingprinciples.</a>
        </p>
        <p>การยกเลิกที่จะใช้ไอบีเอ (Opting out of IBA)<br>ในกรณีที่ท่านประสงค์จะยกเลิกรับโฆษณาตามความสนใจหรือไอบีเอ ไม่ได้หมายความว่าท่านจะไม่ได้รับโฆษณาอีกต่อไปเมื่อท่านใช้บริการของเรา เพียงแต่เราจะไม่ใช้ข้อมูลส่วนบุคคลของท่านสำหรับไอบีเอและโฆษณาที่ท่านเห็นจะไม่ถูกปรับไปตามความสนใจของท่าน ท่านสามารใช้สิทธิดังกล่าวผ่านตัวเลือกโฆษณาออนไลน์ที่
            <!-- --> <a href="http://optout.aboutads.info" title="" target="_blank">http://optout.aboutads.info</a> <!-- -->หรือเข้าไปที่ AdChoices บนโฆษณาและปฏิบัติตามคำแนะนำนั้น ท่านอาจจะยกเลิกไอบีเอได้ภายในครั้งเดียวหลายเว็บไซต์ผ่าน อุปกรร์ยกเลิกเครือข่ายการโฆษณาหรือ (NAI) ที่
            <!-- --> <a href="http://www.networkadvertising.org/choices" title="" target="_blank">(http://www.networkadvertising.org/choices)</a> <!-- -->และสำหรับสหภาพยุโรปที่
            <!-- --> <a href="http://www.youronlinechoices.com/" title="" target="_blank">http://www.youronlinechoices.com/</a> <!-- -->ในกรณีที่ท่านลบคุกกี้ หรือใช้อุปกรณืที่ต่างออกไป หรือเปลี่ยนเว็บบราวเซอร์ ท่านอาจจะต้องยกเลิกอีกครั้งหนึ่ง โฆษณาบนอุปกรณ์โทรศัพท์เคลื่อนที่
        </p>
        <p>โทรศัพท์เคลื่อนที่จะมีสิ่งที่สามารถระบุตัวเครื่องได้เพื่อให้บริษัทต่างๆ สามารถโฆษณาไปยังอุปกรณ์นั้นได้ๆ ในหลายๆกรณี ท่านสามารถปิดโฆษณาที่ติดมาบนอุปกรณ์โทรศัพท์เคลื่อนที่ของท่าน หรือท่านสามารถตั้งค่าโฆษณาที่ติดมาบนอุปกรณ์ใหม่ ณ เวลาใดๆก็ได้ภายในช่องทางการตั้งค่าความเป็นส่วนตัวบนโทรศัพท์เคลื่อนที่ของท่าน อุปกรณ์อื่นที่ท่านสามารถควบคุมการโฆษณาบนอุปกรณ์มือถือคือ AppChoices ที่
            <!-- --> <a href="http://youradchoices.com/appchoices" title="" target="_blank">http://youradchoices.com/appchoices</a>
        </p>
        <p>นอกจากนี้ท่านอาจเลือกที่จะปิดการติดตามตำแหน่งพื้นที่บนโทรศัพท์เคลื่อนทีท่ของท่าน ถ้าท่านปิดเครื่องมือดังกล่าว เราจะไม่สามาถใช้ข้อมูลที่จัดเก็บผ่านสช่องทางการโฆษณาที่ระบุไปยังอุปกรณ์ของท่านสำหรับวัตถุประสงค์ในการโฆษณาได้ ท่านอาจจะยังคงเห็นโฆษณาจำนวนเท่าเดิมแต่จะไม่เกี่ยวข้องกับความสนใจของท่าน ในกรณีที่เราจำเป็นที่จะต้องเก็บข้อมูลที่อยู่ของท่าน เราจะขอความยินยอมจากท่านก่อนทุกครั้ง</p>
        <h2 class="PolicyTitle mt-6">6. ทางเลือกการโฆษณาสำหรับท่าน</h2>
        <p class="mt-4">การโฆษณาทำให้เราสามารถนำมาซึ่งเนื้อหาที่ดีสำหรับแต่ละบริการบนเครือข่ายของเรา โดยเป็นที่รู้กันว่าเนื้อหาเหล่านี้ไม่มีค่าใช้จ่ายใดๆ สำหรับผู้ใช้บริการ ดังนั้น เราใช้ความพยายามอย่างมากในการนำเสนอโฆษณาที่อยู่ในความสนใจของท่านและผลิตภัณฑ์ที่ท่านต้องการ</p>
        <p>เครื่องมือที่อยู่บนหน้าของทางเลือกการโฆษณา ตลอดจนบนหน้าของกลุ่มพันธมิตรโฆษณาดิจิทัล และหน้าระบบริเริ่มเครือข่ายโฆษณาที่สร้างขึ้นโดยบุคคลภายนอกหรือบริษัทคู่ค้า Sanook.com ไม่ได้เป็นผู้ควบคุมหรือใช้งานเครื่องมือเหล่านี้หรือกำหนดทางเลือกต่าง ๆ ที่ผู้โฆษณาทั้งหลายใช้ผ่านเครื่องมือเหล่านี้แต่ประการใด</p>
        <p>เมื่อใช้แอพพลิเคชั่นบนโทรศัพท์มือถือ ท่านอาจได้รับโฆษณาที่พ่วงมาด้วยบนแอพพลิเคชั่น ซึ่งขึ้นอยู่กับอุปกรณ์บนโทรศัพท์มือถือของท่าน ท่านอาจจะสามารถตั้งค่าการบันทึกข้อมูลโฆษณาบนโทรศัพท์มือถือใหม่ตลอดเวลาโดยเข้าถึงการตั้งค่าความเป็นส่วนตัวบนโทรศัพท์มือถือของท่าน นอกจากนี้ บนระบบปฏิบัติการแต่ละประเภท iOS สำหรับโทรศัพท์มือถือแอปเปิล แอนดรอยด์สำหรับอุปกรณ์แอนดรอยด์ และวินโดวร์สำหรับอุปกรณ์ไมโครซอฟต์ จะมีวิธีการของตัวเองสำหรับป้องกันการส่งโฆษณาที่พ่วงมาด้วยบนแอพพลิเคชั่น ท่านอาจต้องศึกษาคู่มือหรือการตั้งค่าความเป็นส่วนตัวสำหรับแต่ละระบบปฏิบัติการเพื่อที่จะนำโฆษณาที่พ่วงมาด้วยกับแอพพลิเคชั่นออกไป และสำหรับอุปกรณ์อื่น ๆ และ/หรืออุปกรณ์บนระบบปฏิบัติการอื่นใดนอกเหนือจากที่กล่าวมา โปรดเข้าไปที่หัวข้อการตั้งค่าความเป็นส่วนตัวสำหรับอุปกรณ์ที่ใช้งาน หรือติดต่อ หรือศึกษานโยบายความเป็นส่วนตัวบนหน้าเว็บไซด์ ของระบบปฏิบัติการนั้น ๆ</p>
        <h2 class="PolicyTitle mt-6">7. การแบ่งปันข้อมูลส่วนบุคคลของท่านร่วมกับผู้อื่น</h2>
        <p class="mt-4">นอกจากที่ท่านได้ให้ความยินยอมไว้ในนโยบายในความเป็นส่วนตัวฉบับนี้หรือตามที่ท่านได้ให้ความยินยอมไว้ในกรณีอื่นๆ เราจะไม่โอนข้อมูลส่วนบุคคลของท่านให้แก่บุคคลภายนอกไม่ว่าเพื่อใช้ในวัตถุประสงค์ใดๆ ก็ตาม <!-- -->เราและบริษัทในเครือของเรา อาจนำข้อมูลของท่านไปแบ่งปันกับบริษัทอื่นๆภายในกลุ่ม รวมถึงพันธมิตรผู้ร่วมทุนและผู้ให้บริการภายนอก ผู้รับเหมา และตัวแทน(เช่นผู้ให้บริการด้านการสื่อสารข้อมูลซึ่งจะจัดส่งอีเมล์หรือการแจ้งข้อมูลในนามของเรารวมไปถึงผู้ให้บริการในการแปลงข้อมูลซึ่งให้ความช่วยเหลือเราและท่านเกี่ยวกับข้อมูลเกี่ยวกับตำแหน่งพื้นที่ ผู้ให้บริการในการวิเคราะห์ข้อมูลซึ่งให้ความช่วยเหลือในด้านธุรกิจและการโฆษณาเกี่ยวกับบริการของเรา) นอกจากนี้เราอาจอนุญาตให้บุคคลอื่นเก็บรวบรวมข้อมูลส่วนบุคคลของท่านจากการใช้บริการของเราโดยในแต่ละกรณีเราจะอนุญาตให้มีการใช้ข้อมูลของท่าน และ/หรือเก็บรวบรวมข้อมูลของท่านเพื่อวัตถุประสงค์ดังต่อไปนี้ (1) ให้บริการแก่ท่าน (2) ช่วยเหลือเราเกี่ยวกับการดำเนินการตามวัตถุประสงค์ที่ระบุไว้ในหัวข้อ ”เราใช้ข้อมูลของท่านอย่างไร” ข้างต้น (3) ดำเนินการตามข้อผูกพันและการบังคับใช้สิทธิของเราภายใต้
            <!-- --> ข้อกำหนดการใช้บริการ <!-- -->หรือนโยบายในความเป็นส่วนตัวฉบับนี้ และ/หรือ(4)ธุรกิจของเราซึ่งรวมไปถึงการนำข้อมูลไปใช้เพื่อให้เราสามารถทำความเข้าใจและปรับปรุงการบริการของเรา ทั้งนี้ บุคคลภายนอกดังกล่าวอาจเข้าถึงข้อมูลส่วนบุคคลของท่านรวมถึงนำไปใช้และเก็บรักษาข้อมูลดังกล่าวนอกเหนือจากที่ท่านได้ให้ความยินยอมไว้ตามที่ได้กล่าวมา
        </p>
        <p>ในกรณีที่เราอนุญาตให้บุคคลอื่นเก็บรวบรวมและใช้ข้อมูลส่วนบุคคลของท่านตามเงื่อนไขที่ระบุไว้ในวรรคก่อนเราจะดำเนินการตามสมควรเพื่อให้แน่ใจว่าบุคคลอื่นเหล่านั้นจะใช้ข้อมูลส่วนบุคคลของท่านเพื่อวัตถุประสงค์ในเรื่องดังต่อไปนี้เท่านั้น(1)เป็นไปโดยสอดคล้องกับนโยบายในความเป็นส่วนตัวฉบับนี้และ (2) อยู่ภายใต้บังคับของคำสั่งอื่นๆที่เราได้กำหนดและแจ้งให้แก่บุคคลข้างต้นได้รับทราบรวมถึงนำมาตรการที่เหมาะสมที่เราใช้ในการ รักษาความลับและความปลอดภัยของข้อมูลไปปฏิบัติด้วย</p>
        <p>ท่านให้ความยินยอมแก่บุคคลอื่นตามที่ระบุไว้เพื่อใช้ข้อมูลส่วนบุคคลของท่านรวมถึงการนำข้อมูลส่วนบุคคลของท่านไปแบ่งปันหรือโอนให้กับผู้อื่น(รวมทั้งกรณีที่อยู่ในและอยู่นอกเขตอำนาจศาลที่ใช้บังคับกับท่าน)ตามที่ได้ระบุไว้ในหัวข้อ “การแบ่งปันข้อมูลส่วนบุคคลของท่านร่วมกับผู้อื่น”</p>
        <p>เนื่องจากเราได้มีการพัฒนาธุรกิจของเราอยู่ตลอดเวลาดังนั้นเราหรือบริษัทในเครือของเราอาจถูกโอนให้กับบุคคลอื่นหรือมีการปรับโครงสร้างภายในกลุ่มของเราได้โดยในกรณีเช่นว่านี้อาจทำให้มีการโอนข้อมูลส่วนบุคคลของท่านระหว่างภายในกลุ่มของเรา และ/หรือไปยังบุคคลภายนอกซึ่งจะเป็นผู้ให้บริการของเราหรือ ที่คล้ายคลึงกับบริการของเราตามนโยบายในความเป็นส่วนตัวฉบับนี้หรือ นโยบายในความเป็นส่วนตัวอื่นๆ ซึ่งเราจะแจ้งให้ท่านทราบ ทั้งนี้ ผู้ที่ได้รับโอนข้อมูลส่วนบุคคลของท่านอาจมีสำนักงานตั้งอยู่หรือนำข้อมูลของท่านไปใช้นอกเขตอำนาจศาลที่ใช้บังคับกับท่าน</p>
        <p>ท่านตกลงว่าเราและบริษัทในเครือของเราอาจจำเป็นที่จะต้องคงไว้ เก็บรักษาหรือเปิดเผยข้อมูลส่วนบุคคลของท่าน(1) เพื่อปฏิบัติตามหลักเกณฑ์และกฎหมายที่เกี่ยวข้อง (2)เพื่อปฏิบัติตามคำสั่งศาล หมายศาลหรือกระบวนการในทางกฎหมายอื่นๆ (3) เพื่อดำเนินการตามคำร้องขอของหน่วยงานของรัฐ หน่วยงานทีมีอำนาจบังคับใช้กฎหมายหรือหน่วยงานอื่นใดในทำนองเดียวกัน (ไม่ว่าจะตั้งอยู่ในเขตอำนาจศาลที่ใช้บังคับกับท่านหรือที่อื่นก็ตาม) หรือ(4) ในกรณีที่เราเชื่อว่ามีความจำเป็นอันสมควรที่จะต้องปฏิบัติตามหลักเกณฑ์หรือกฎหมายที่เกี่ยวข้อง ทั้งนี้ท่านตกลงว่าเราหรือบริษัทในเครือของเราอาจจำเป็นที่จะต้องเปิดเผยข้อมูลส่วนบุคคลของท่านเพื่อบังคับใช้เงื่อนไขเกี่ยวกับการให้บริการหรือนโยบายในความเป็นส่วนตัวฉบับนี้เพื่อความมุ่งหมายในการปกป้องสิทธิของเรา ทรัพย์สินหรือความปลอดภัยหรือสิทธิ ทรัพย์สินหรือความปลอดภัยของบริษัทในเครือของเราหรือผู้ใช้บริการของเรารายอื่นๆ</p>
        <p>ข้อพิจารณาเกี่ยวกับข้อมูลที่แบ่งปันร่วมกัน</p>
        <p>บริการของเราจะทำให้ข้อมูลที่แบ่งปันร่วมกันได้นำไปเปิดเผยในสาธารณะร่วมกับข้อมูลของผู้ใช้ทุกรายที่ใช้บริการนั้นและมิใช่จำกัดอยู่เพียงแค่ข้อมูลของบุคคลที่อยู่ในรายชื่อผู้ติดต่อของท่าน การให้บริการโซเชียลมีเดียของเราได้ถูกออกแบบในขั้นพื้นฐานมาเพื่อให้ความช่วยเหลือแก่ท่านในการแบ่งปันข้อมูลที่แบ่งปันร่วมกันกับบุคคลอื่นที่อยู่บนโลกใบนี้ ดังนั้น ข้อมูลที่แบ่งปันร่วมกันดังกล่าวจะสามารถจัดส่งไปได้อย่างกว้างขวางและในทันทีโดยที่ข้อมูลดังกล่าวจะยังเป็นข้อมูลสาธารณะตราบเท่าที่ท่านยังมิได้ลบมันออกไป(และแม้ว่าท่านจะลบข้อมูลที่มีการแบ่งปันร่วมกับผู้อื่นดังกล่าวไปแล้วก็ตามข้อมูลนั้นอาจจะยังคงถูกจัดเก็บเป็นการชั่วคราว ทำสำเนาหรือเก็บรักษาไว้ หรือยังคงเป็นข้อมูลสาธารณะโดยผู้อื่นหรือผู้ใช้รายอื่นซึ่งไม่ได้เป็นผู้ที่เกี่ยวข้องกับเราและ เราไม่สามารถควบคุมได้)</p>
        <p>กรุณาพิจารณาอย่างรอบคอบเมื่อท่านจะทำการโพสต์ข้อความและติดต่อสื่อสารผ่านทางบริการของเรา</p>
        <h2 class="PolicyTitle mt-6">8. การติดต่อสื่อสารจากเรา</h2>
        <p class="mt-4"> จดหมายข่าวและการติดต่อสื่อสารในรูปแบบอื่น </p>
        <p>เมื่อท่านใช้บริการของเรา เราอาจใช้ข้อมูลของท่านเพื่อจัดส่งอีเมล์ จดหมายข่าว หรือการแจ้งข้อมูลมายังอุปกรณ์ของท่านได้ ในกรณีที่ท่านไม่ประสงค์จะได้รับการติดต่อสื่อสารดังกล่าวอีกต่อไป ท่านสามารถกระทำได้โดยการปฏิบัติตามรายละเอียดของการยกเลิกการรับข้อมูลตามที่ปรากฏอยู่ในอีเมล์ที่เราจัดส่งให้แก่ท่าน หรือทำการปิดระบบการแจ้งเตือนที่อยู่ในอุปกรณ์ของท่าน(ในกรณีที่สามารถทำได้) หรือติดต่อเจ้าหน้าที่ดูแลความเป็นส่วนตัวของเรา</p>
        <p><b>ประกาศที่เกี่ยวกับบริการ</b></p>
        <p>เราอาจจะจัดส่งประกาศที่เกี่ยวกับบริการให้แก่ท่านเป็นครั้งคราวเมื่อเราเห็นว่ามีความจำเป็นที่จะต้องดำเนินการในเรื่องนั้น(เช่นเมื่อเราระงับการให้บริการเป็นการชั่วคราวในบริการใดบริการหนึ่งเพื่อการบำรุงรักษา) ซึ่งท่านจะไม่สามารถทำการเลือกเพื่อปิดการรับประกาศเกี่ยวกับบริการดังกล่าวนี้ซึ่งมิได้มีเนื้อหาเป็นการประชาสัมพันธ์แต่งอย่างใด</p>
        <h2 class="PolicyTitle">9. ข้อพิจารณาเกี่ยวกับข้อมูลส่วนบุคคลที่มีความสำคัญ (Sensitive Personal Information)</h2>
        <p>ในเขตอำนาจศาลบางแห่งข้อมูลส่วนบุคคลในบางกรณีเช่น ข้อมูลเกี่ยวกับเชื้อชาติ ชาติพันธุ์ ศาสนา ความเชื่อในเรื่องปรัชญาหรือข้อมูลด้านสุขภาพถูกกำหนดให้เป็น”ข้อมูลสำคัญ”และอยู่ภายใต้บังคับของกฎ ระเบียบที่มีความเข้มงวดมากกว่าข้อมูลส่วนบุคคลในกรณีอื่นๆ ทั้งนี้โปรดสังเกตว่าเนื้อหาและข้อมูลที่ท่านได้ใช้ในบริการของเราเช่นรูปภาพหรือข้อมูลเกี่ยวกับโรงเรียนหรือกิจกรรมทางสังคมของท่านอาจเปิดเผยข้อมูลส่วนบุคคลที่มีความสำคัญของท่านให้แกjบุคคลอื่นทราบได้</p>
        <p><strong>โปรดสังเกตว่าเรามิได้ใช้ข้อมูลส่วนบุคคลที่มีความสำคัญของท่านเพื่อวัตถุประสงค์ในการโฆษณาใดๆ แก่ท่าน</strong></p>
        <p>เราขอให้ท่านพิจารณาว่าการสื่อสารข้อมูลส่วนบุคคลที่มีความสำคัญในบริการของเราเป็นเรื่องที่มีความเหมาะสมหรือไม่</p>
        <h2 class="PolicyTitle">10. บริการของบุคคลอื่นที่รวมอยู่ในบริการของเรา</h2>
        <p>บริการของเราอาจมีข้อมูลหรืออาจมีการเชื่อมต่อท่านไปยังข้อมูลเกี่ยวกับโซเชียลมีเดียหรือบริการอื่นๆ(รวมถึงเว็บไซต์)ของผู้อื่นได้ ตัวอย่างเช่น</p>
        <ul>
            <li>ในบางกรณีท่านสามารถที่จะแบ่งปันเนื้อหาของท่านในบริการของเราผ่านทางบริการของบุคคลอื่น ซึ่งบุคคลอื่นที่จัดให้มีบริการดังกล่าวอาจเก็บรวบรวมข้อมูลของท่านและข้อมูลส่วนตัวของท่าน (รวมไปถึงข้อมูลเกี่ยวกับการเข้าใช้บริการ) และอาจจัดส่งคุกกี้มาในคอมพิวเตอร์ของท่านเพื่อให้บริการของบุคคลภายนอกสามารถทำงานได้อย่างเหมาะสม และ</li>
            <li>เราอาจจะ(ไม่ว่าจะอยู่ในโฆษณาหรืออยู่ในส่วนอื่นในบริการของเราก็ตาม) จัดส่งลิ้งค์ให้แก่ท่านเพื่อให้ท่านสามารถเข้าถึงบริการหรือเว็บไซต์ของบุคคลอื่นนั้นได้</li>
        </ul>
        <p>บริการโซเชียลมีเดียหรือบริการอื่นๆของผู้ให้บริการภายนอกเหล่านี้อาจเป็นการให้บริการโดยบุคคลภายนอกที่เกี่ยวข้องหรือโดยเราก็ได้ การใช้บริการภายนอกข้างต้น(ไม่ว่าจะเป็นบริการโซเชียลมีเดียหรือบริการอื่นใดก็ตาม)รวมถึงข้อมูลส่วนบุคคลที่ท่านมีการส่งให้กับบุคคลภายนอกดังกล่าวจะอยู่ภายใต้บังคับของเงื่อนไขการให้บริการและนโยบายในความเป็นส่วนตัวที่เกี่ยวข้องของบุคคลภายนอกนั้นๆและ
            <!-- --> <strong>ข้อกำหนดการใช้บริการ</strong> <!-- -->ของเราหรือนโยบายในความเป็นส่วนตัวฉบับนี้จะไม่นำไปใช้บังคับ ดังนั้นกรุณาพิจารณาเงื่อนไขต่างๆของผู้ให้บริการภายนอกดังกล่าวอย่างรอบคอบ
        </p>
        <p>นโยบายในความเป็นส่วนตัวฉบับนี้จะใช้บังคับกับข้อมูลที่เราเป็นผู้เก็บรวบรวมเท่านั้นและจะไม่นำไปใช้บังคับกับบริการของผู้ให้บริการภายนอกหรือวิธีดำเนินการเกี่ยวกับข้อมูลของผู้ให้บริการภายนอกดังกล่าวและเราจะไม่มีความรับผิดในการที่ผู้ให้บริการภายนอกนำข้อมูลของท่านไปใช้แต่อย่างใด</p>
        <h2 class="PolicyTitle">11. ข้อจำกัดในเรื่องอายุ</h2>
        <p>เราไม่ได้มุ่งการให้บริการไปยังผู้เยาว์ที่อายุต่ำกว่า 10 ปี เนื่องจากบริการของเรามีความจำเป็นต้องใช้วิจารณญาณในการรับชม จึงมุ่งเน้นให้บริการแก่บุคคลที่บรรลุนิติภาวะแล้วตามกฎหมาย อย่างไรก็ตาม เนื่องจากบริการของเราบุคคลสามารถเข้าถึงได้โดยทั่วไป ดังนั้น หากปรากฏว่าเราได้เก็บรวบรวมข้อมูลผู้เยาว์ที่มีอายุต่ำกว่า 10 ปี และ/หรือบุคคลที่ยังไม่บรรุลนิติภาวะ กรุณาติดต่อเจ้าหน้าที่ดูแลความเป็นส่วนตัวของเรา และเราจะตรวจสอบข้อมูลส่วนบุคคลดังกล่าวในทันที (รวมถึงลบข้อมูลดังกล่าวในกรณีที่เราตรวจพบ)</p>
        <h2 class="PolicyTitle">12. การถ่ายโอนระหว่างประเทศ</h2>
        <p>บริการนี้ถูกควบคุมกำกับดูแลและดำเนินการภายใต้กฎหมายของราชอาณาจักรไทย หากท่านอยู่นอกพื้นที่ราชอาณาจักรไทย ถือว่าท่านได้ใช้บริการนี้ด้วยความเสี่ยงของตัวท่านเอง โดยที่บริษัท Sanook.com อาจมีความจำเป็นที่จะต้องถ่ายโอนข้อมูลของท่านระหว่างประเทศ โดยเฉพาะอย่างยิ่ง ข้อมูลของท่านจะถูกถ่ายโอนไปยังและจัดการอยู่ในราชอาณาจักรไทยที่เป็นศูนย์รวมข้อมูลของเรา และท่านรับทราบว่าการปกป้องข้อมูลและกฎหมายอื่นของต่างประเทศที่ไม่ใช่ประเทศของท่าน เช่น ราชอาณาจักรไทย อาจมีความคุ้มครองหรือมาตรฐานการคุ้มครองน้อยกว่าที่มีอยู่ในประเทศของท่าน และท่านยินยอมให้เก็บข้อมูล ดำเนินการและถ่ายโอนข้อมูลของท่านตามที่กำหนดไว้ในนโยบายความเป็นส่วนตัวและกฎหมายราชอาณาจักรไทยสำหรับการใช้บริการนี้ นอกจากนี้เราจะทำตามขั้นตอนตามกฎหมายอย่างเหมาะสมเพื่อที่จะมั่นใจว่าข้อมูลส่วนบุคคลถูกจัดการ รักษา และถ่ายโอนอย่างปลอดภัย ในบางกรณีเราอาจจำเป็นที่จะต้องเปิดเผยหรือโอนถ่ายข้อมูลส่วนบุคคลไปยังสำนักงานใหญ่ หรือบุคคลภายนอก ในพื้นที่นอกเหนือจากประเทศของท่าน</p>
        <h2 class="PolicyTitle">13. การรักษาความปลอดภัยของข้อมูล</h2>
        <p>เรามีการวางโครงสร้างทั้งทางกายภาพ ระบบอิเล็กทรอนิกส์ และกระบวนการบริหารจัดการที่ออกแบบมาเพื่อป้องกันการเข้าถึงข้อมูลโดยไม่ได้รับอนุญาตเพื่อรักษาความปลอดภัยของข้อมูล และเพื่อใช้ข้อมูลที่เราเก็บมาได้อย่างถูกต้อง การรักษาความปลอดภัยเหล่านี้มีหลายรูปแบบขึ้นอยู่กับความสำคัญของข้อมูลที่เราได้มาหรือจัดเก็บไว้</p>
        <p>ในบางกรณีเราอาจใช้เทคโนโลยีในการเข้ารหัส(เช่นระบบเอสเอสแอล)เพื่อคุ้มครองข้อมูลที่มีความสำคัญบางอย่างซึ่งท่านจัดส่งให้แก่เรา ทั้งนี้ขอให้ท่านโปรดรับทราบด้วยว่าไม่ว่าเราจะใช้ความพยายามในการดำเนินการเพียงใด แต่ยังไม่มีมาตรการในการรักษาความปลอดภัยของข้อมูลใดที่สามารถรับประกันความปลอดภัยได้100% ตลอดเวลา โดยที่ระบบและเครือข่ายในการสื่อสารของเราซึ่งเชื่อมต่อท่านในการเข้าถึงบริการของเราอาจเกิดกรณีที่มีการละเมิดมาตรการในด้านการรักษาความปลอดภัยและมีความผิดพลาดซึ่งเป็นสถานการณ์ที่อยู่นอกเหนือการควบคุมตามสมควรของเรา</p>
        <h2 class="PolicyTitle">14. การเก็บรักษาข้อมูลส่วนบุคคล และเก็บนานเท่าไหร่</h2>
        <p>ภายใต้บังคับของหลักเกณฑ์และกฎหมายที่เกี่ยวข้อง (รวมถึงเงื่อนไขตามที่ระบุไว้ในหัวข้อ “การแบ่งปันข้อมูลส่วนบุคคลของท่านร่วมกับผู้อื่น” ข้างต้น) เราจะเก็บรักษาข้อมูลส่วนบุคคลของท่านตราบเท่าที่จำเป็นสำหรับการดำเนินการตามวัตถุประสงค์ที่ระบุไว้ในหัวข้อ “เราใช้ข้อมูลของท่านอย่างไร” ตามที่ได้กล่าวมาข้างต้นเท่านั้น</p>
        <p>เราจะเก็บข้อมูลของท่านเป็นไปตามระยะเวลาการเก็บรักษาและความจำเป็นในการใช้ข้อมูลของเรา ท่านสามารถหาข้อมูลเพิ่มเติมได้ที่ข้อกำหนดการเก็บรักษาข้อมูลสำหรับคำนวณเวลาการเก็บรักษาข้อมูลที่ระบุไว้ด้านล่าง</p>
        <p>Sanook.com มีฝ่ายดูแลและจัดเก็บข้อมูลที่ทำงานร่วมกับฝ่ายดูแลข้อมูลส่วนบุคคลเพื่อที่จะพัฒนาปรับปรุงนโยบายและกฎเกณฑ์ต่างๆที่เกี่ยวกับการเก็บรักษาข้อมูลส่วนบุคคล เรามีข้อกำหนดการเก็บรักษาข้อมูลเป็นไปตามแต่ละแผนธุรกิจ ประกอบไปด้วย รูปแบบของธุรกิจ รูปแบบการบันทึก และรูปแบบการจัดเก็บ</p>
        <p>เราคำนวณระยะเวลาการจัดเก็บรักษาข้อมูลส่วนบุคคลเป็นไปตามกฎเกณฑ์ดังต่อไปนี้</p>
        <ol>
            <li>ระยะเวลาที่จำเป็นสำหรับการปฏิบัติตามวัตถุประสงค์ในการจัดเก็บ</li>
            <li>เมื่อท่าน (หรือบุคคลอื่นที่ให้ท่านเข้าถึงบริการของเรา) หยุดการใช้บริการของเรา
                <!-- -->
            </li>
            <li>ระยะเวลาตามสมควรในการจัดเก็บที่แสดงให้เห็นว่าเราได้ทำตามหน้าที่และข้อตกลงต่างๆ</li>
            <li>ภายในระยะเวลาที่จำกัดที่อาจมีข้อเรียกร้องเกิดขึ้น</li>
            <li>ภายในระยะเวลาการเก็บรักษาที่สอดคล้องกับกฎหมายหรือได้รับการแนะนำจากผู้ควบคุม ผู้ออกกฎเกณฑ์ เจ้าหน้าที่รัฐ หรือองค์กรรัฐ</li>
            <li>หรือความจำแป็นที่ต้องมีอยู่เพื่อการให้บริการใดๆ แก่ท่าน</li>
        </ol>
    </div>
</section>
