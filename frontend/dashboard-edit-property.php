...
location_property.amphure_id,location_property.postal_code,location_property.lat,location_property.lng,property_type.p_type,advertise.pack_id
FROM ((((advertise
                                ...
                                <div class="card mb-6">
                                  <div class="card-body p-6">
                                    ...
                                    <div class="form-row mx-n2">
                                      ...
                                      <div class="col-md-6 col-lg-12 col-xxl-6 px-2">
                                        <div class="form-group">
                                          <label for="price" class="text-heading"> ที่จอดรถ <span class="red">*</span></label>
                                      ...
                                      <div class="col-md-6 col-lg-12 col-xxl-6 px-2">
                                        <div class="form-group">
                                          ...
                                          <input type="number" class="form-control form-control-lg border-0" id="space_area" name="space_area" value="<?php echo $rowb['space_area']; ?>" required>
                                        </div>
                                      </div>
                                    </div>
                                    <div class="form-group">
                                      <label for="price" class="text-heading"> ราคา <span class="red">*</span><span class="text-muted">บาท</span></label>
                                  ...
                                  <div class="card-body p-6">
                                    ...
                                    <div class="profile-images-card">
                                      <div class="profile-images">
                                        <img src="../image/p_img/<?php echo $rowb['img_video']; ?>" id="uploaded_image" width="100">
                                      </div>
