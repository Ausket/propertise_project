...
<body>
  ...
  <main id="content">
    <section class="pb-4 shadow-xs-5" style="padding-top: 50px !important;">
      <div class="container">
        <h1 class="fs-30 lh-1 mb-0 text-heading font-weight-600 mb-6" style="margin-bottom: 0 !important;">แพ็คเกจ</h1>
      </div>
    </section>
    <section class="py-8">
      <div class="container">
        <h4 class="mb-2 fs-22 lh-15 text-heading">เลือกแพ็คเกจที่เหมาะกับธุรกิจของคุณ</h4>
