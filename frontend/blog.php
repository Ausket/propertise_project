...
<head>
  ...
  <title>Blog List With Sidebar - HomeID</title>
  <!-- Google fonts -->
  ...
  <meta name="twitter:title" content="Blog List With Sidebar">
  <meta name="twitter:description" content="Real Estate Html Template">
  <meta name="twitter:image" content="images/homeid-social-logo.png">
  <!-- Facebook -->
  <meta property="og:url" content="blog-list-width-sidebar.html">
  <meta property="og:title" content="Blog List With Sidebar">
...
<body>
  ...
  <main id="content">
    <section class="pt-2 pb-13 page-title bg-img-cover-center bg-white-overlay" style="background-image: url('../images/bg-title.jpg');">
      <div class="container">
        <h1 class="fs-30 lh-15 mb-0 text-heading font-weight-500 text-center pt-10" data-animate="fadeInDown"> อัพเดทบทความที่น่าสนใจรายวัน </h1>
      </div>
    </section>
        ...
        <div class="row ml-xl-0 mr-xl-n6" id="precard">
          <?php while ($rowa = mysqli_fetch_array($resulta)) { ?>
            <?php if ($rowa['a_status'] == '1') { ?>
              <div class="col-lg-12 mb-6 mb-lg-0 pr-xl-6 pl-xl-0" id="cardtwo">
                <div class="card border-0 mb-6 pb-6 border-bottom" id="cardthree">
