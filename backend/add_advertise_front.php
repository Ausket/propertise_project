...
if ($file != '') {
    ...
    if (isset($_POST['submit1'])) {
        ...
        if ($numad == 0) {
            ...
            echo "</script>";
            header('Refresh:0; url=../frontend/dashboard-add-property.php');
        } else {
            ...
            if (isset($_POST["facility"])) {
                $sql = "INSERT INTO property_detail(ptype_id,l_id,project_name,bedroom,bathroom,parking,price,img_video,space_area,u_id,facility) VALUES('$ptype','$l_id','$project_name','$bedroom','$bathroom','$parking','$price','$file','$space_area','$id','$facility') ";
            } else {
                $sql = "INSERT INTO property_detail(ptype_id,l_id,project_name,bedroom,bathroom,parking,price,img_video,space_area,u_id) VALUES('$ptype','$l_id','$project_name','$bedroom','$bathroom','$parking','$price','$file','$space_area','$id') ";
            }
