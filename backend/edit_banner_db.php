...
if ($file != '') {
    ...
    $sql = "UPDATE article SET a_title='$title',a_note= '$note',at_id='8',a_img='$newname' WHERE a_id = $id";
    $result = mysqli_query($con, $sql) or die(mysqli_error($con)) ;

    echo '<script> window.location.href = "../page/banner.php";alert("แก้ไขข้อมูลสำเร็จ")</script>';
   
   
}
if ($file == '') {

    $sql = "UPDATE article SET a_title='$title',a_note= '$note',at_id='8' WHERE a_id = $id";
    $result = mysqli_query($con, $sql) or die(mysqli_error($con)) ;
